...
const Map<String, Map<String, String>> localeItems = {
  'AllInOne': {
    languageEn: 'All game modifications in a single library',
    languageRu: 'Все игровые модификации в библиотеке ExLoader',
    languageUa: 'Всі ігрові модифікації в бібліотеці ExLoader',
    languagePl: 'Wszystkie modyfikacje gry w jednej bibliotece',
    languageDe: "Alle Spieländerungen in einer einzigen Bibliothek",
    languageIt: 'Tutte le modifiche al gioco in un`unica libreria',
  ...
  'AddToBookmarksHint': {
    ...
    languageRu: 'Добавить в избранное',
  ...
  'RemoveFromBookmarkedHint': {
    ...
    languageRu: 'Убрать из избранного',
  ...
  'MediumPlural': {
    ...
    languageRu: 'Продвинутые | Полу-рейдж',
    languageUa: 'Просунуті | Напів-рейдж',
    languagePl: 'Zaawansowane | Semi-rage',
    languageDe: "Erweiterte | Semi-rage",
    languageIt: 'Avanzato | Semi-rage',
  ...
  'AdvancedPlural': {
    ...
    languageRu: 'Универсальные | Хвх',
    languageUa: 'Універсальні | Хвх',
    languagePl: 'Uniwersalne | Hvh',
    languageDe: "Universelle | Hvh",
    languageIt: 'Universale | HvH',
  ...
  'OpticalPlural': {
    ...
    languageRu: 'Визуальные | Скины',
    languageUa: 'Візуальні | Скіни',
    languagePl: 'Wizualne | Skins',
    languageDe: "Visuelle | Skins",
    languageIt: 'Visuale | Skins',
  ...
  'PressToOpenMenu': {
    ...
    languageRu: "Меню модификации открывается кнопкой {key}",
  ...
  'InstallConfigs': {
    ...
    languageRu: 'Установить конфиги к модификации',
  ...
  'OpenConfigFolder': {
    ...
    languageRu: 'Открыть папку файлов модификации',
  ...
  'RemoveModificationFiles': {
    ...
    languageRu: 'Удалить все файлы модификации',
  ...
  'ModificationDoesNotWork': {
    ...
    languageRu: 'Модификация не работает, помогите',
  ...
  'ContactSupport': {
    ...
    languageRu: 'Связаться с поддержкой {mod}',
  ...
  'LaunchGuide': {
    ...
    languageRu: 'Инструкция к запуску модификации',
  ...
  'PictureMayDiffer': {
    languageEn:
        'The modification from the screenshot may differ from its current version',
    languageRu:
        'Модификация на скриншоте может отличаться от её актуальной версии',
    languageUa:
        'Модифікація на скріншоті може відрізнятися від її актуальної версії',
    languagePl:
  ...
  'OkayButDoNotShowItAgain': {
    ...
    languageRu: 'Хорошо, не показывать это снова!',
  ...
  'EraseActivity': {
    ...
    languageRu: 'Очистка следов активности мода',
  ...
  'ReadMore': {
    ...
    languageRu: 'Прочитать подробнее',
  ...
  'PressToSaveMark': {
    ...
    languageRu: 'Нажми, и твоя оценка сохранится',
  ...
  'SearchByModifications': {
    ...
    languageRu: 'Поиск по модификациям',
  ...
  'SearchByModificationsAndVersions': {
    ...
    languageRu: 'Поиск по модификациям и их версиям',
    languageUa: 'Пошук за модифікаціями та їх версіями',
    languagePl: 'Szukaj według modyfikacji i wersji',
    languageDe: "Suche nach Modifikationen und Versionen",
    languageIt: 'Ricerca per modifiche e relative versioni',
  ...
  'NothingFoundByYourQuery': {
    ...
    languageRu: 'По твоему запросу ничего не найдено',
  ...
  'WelcomeBackUser': {
    ...
    languageRu: 'С возвращением, {user}',
  ...
  'ReviewsComplaintsGames': {
    ...
    languageRu: 'на комментарии к играм',
  ...
  'CommentsDescription': {
    ...
    languageRu: 'Управление жалобами на комментарии',
  ...
  'ProfilesDescription': {
    ...
    languageRu: 'Редактирование профилей и их блокировка',
  ...
  'UserComments': {
    ...
    languageRu: 'Комментарии пользователей',
  ...
  'ModificationsOpenHideKey': {
    ...
    languageRu: 'Клавиша взаимодействия с меню модификаций',
  ...
  'KeyIsOccupied': {
    ...
    languageRu: 'Выбранная тобой клавиша уже используется в одной из функций!',
    languageUa: 'Обрана тобою клавіша вже використовується в одній з функцій!',
  ...
  'GameAutoLaunch': {
    ...
    languageRu: 'Автоматически запускать игру',
  ...
  'GameAutoLaunchDescription': {
    languageEn:
        'ExLoader will launch the game(applicable only for Steam games) itself before injecting the modification',
    languageRu:
        'ExLoader самостоятельно запустит игру(применимо только к играм из Steam) перед инъекцией',
    languageUa:
        "ExLoader самостійно запустить гру (застосовується тільки до ігор з Steam) перед ін'єкцією",
    languagePl:
  ...
  'NotifyAboutChanges': {
    ...
    languageRu: 'Получение уведомлений о модификациях',
  ...
  'ChangeBackgroundAutomatically': {
    ...
    languageRu: 'Автоматическое изменение цвета и фона',
  ...
  'FetchWeather': {
    ...
    languageRu: 'Синхронизировать погоду',
  ...
  'FetchWeatherDescription': {
    languageEn:
        'Snowing or raining outside the window? Make the same weather in the app with just one click!',
    languageRu:
        'За окном идёт снег или дождь? Перенеси его в приложение с помощью всего одной галочки!',
    languageUa:
        'За вікном йде сніг або дощ? Перенеси його в додаток за допомогою всього однієї галочки!',
    languagePl:
  ...
  'GrainEffect': {
    ...
    languageRu: 'Эффект шероховатости',
  ...
  'CouldNotSelectThisImage': {
    languageEn:
        'Unfortunately, ExLoader could not analyze your image. You can try selecting another one!',
    languageRu:
        'К сожалению, ExLoader не смог обработать твою картинку, попробуйте выбрать другую!',
    languageUa:
        'На жаль, ExLoader не зміг обробити твою картинку, спробуйте вибрати іншу!',
    languagePl:
  ...
  'ChooseAnImage': {
    ...
    languageRu: 'Выбери файл желаемой картинки',
  ...
  'BackgroundIsAlreadyInstalled': {
    ...
    languageRu: 'Выбранный тобой фон уже добавлен в приложение!',
    languageUa: 'Обраний тобою фон вже додан в додатку!',
  ...
  'ImageIsSaved': {
    ...
    languageRu: 'Твоя картинка сохранена и применена!',
  ...
  'Background': {
    languageEn: 'Background image and transparency',
    languageRu: 'Задний фон и прозрачность',
    languageUa: 'Задній фон і прозорість',
    languagePl: 'Tło i przezroczystość',
    languageDe: "Hintergrund und Transparenz",
    languageIt: 'Sfondo e trasparenza',
    languageTr: "Arka plan ve şeffaflık",
    languageEs: "Fondo y transparencia",
    languageCn: "背景和透明度",
  },
  'DeleteThisImage': {
    languageEn: 'Delete this background',
    languageRu: 'Удалить этот фон',
  ...
  'OpenImageDirectory': {
    ...
    languageRu: 'Открыть папку с резервной копией',
  ...
  'OnEachRestart': {
    ...
    languageRu: 'При перезапуске приложения',
  ...
  'ApplyingYourImage': {
    ...
    languageRu: 'Обрабатываем твою картинку перед её сохранением',
  ...
  'ApplyingYourAvatar': {
    ...
    languageRu: 'Обрабатываем твою аватарку',
  ...
  'AdaptForNewThemes': {
    ...
    languageRu: 'Адаптация под специальные ивенты',
  ...
  'AdaptForNewThemesDescription': {
    languageEn:
        "The application's background and some of it's elements will transform themselves depending on the current holiday",
    languageRu:
        'Фон приложения и его некоторые элементы будут меняться в зависимости от проходящего сейчас праздника',
    languageUa:
        'Фон додатку і його деякі елементи будуть змінюватися в залежності від проходящого зараз свята',
    languagePl:
  ...
  'All': {
    ...
    languageRu: 'Получать уведомления обо всех модификациях',
  ...
  'None': {
    ...
    languageRu: 'Не получать подобных уведомлений',
  ...
  'ClearList': {
    ...
    languageRu: 'Очистить список запущенных игр',
  ...
  'ClearListExecuted': {
    languageEn:
        'The list of games to which you have launched or installed modifications has been cleared!',
    languageRu:
        'Список игр, к которым ты запускал или же устанавливал модификации очищен!',
    languageUa:
        'Список ігор, до яких ти запускав або ж встановлював модифікації очищен!',
    languagePl:
  ...
  'NotificationsAboutComplaints': {
    ...
    languageRu: 'Уведомления о статусе жалоб',
  ...
  'NotificationsAboutAnswers': {
    ...
    languageRu: 'Получать уведомления об ответах',
  ...
  'NotificationsAboutAnswersDescription': {
    languageEn:
        "When somebody adds a response to your review, you will receive the appropriate notification",
    languageRu:
        'При добавлении ответа к твоему комментарию ты получишь соотвествующее уведомление',
    languageUa:
        'При додаванні відповіді до твого коментаря ти отримаєш відповідне повідомлення',
    languagePl:
  ...
  'CanNotChangeThisInOfflineMode': {
    languageEn:
        "Unfortunately, you can't change profle settings in offline mode!",
    languageRu:
        'К сожалению, ты не можешь изменять настройки, связанные с профилем в автономном режиме!',
    languageUa:
        "На жаль, ти не можеш змінювати налаштування, пов'язані з профілем в автономному режимі!",
    languagePl:
  ...
  'MultipleFoldersDetected': {
    languageEn:
        "ExLoader has found several possible folders for this modification configs installation and opened them all!",
    languageRu:
        'ExLoader обнаружил сразу несколько возможных папок для установки конфигов к этой модификации и открыл их все!',
    languageUa:
        'ExLoader виявив відразу декілька можливих папок для установки конфігів до цієї модифікації і відкрив їх всі!',
    languagePl:
  ...
  'NotAvailable': {
    languageEn:
        "Unfortunately, this modification does not compatible with this feature!",
    languageRu:
  ...
  'CloudConfigSystemFolder': {
    ...
    languageRu:
        'Данная модификация использует систему облачных конфигураций вместо локального хранилища!',
    languageUa:
        'Дана модифікація використовує систему хмарних конфігурацій замість локального сховища!',
    languagePl:
  ...
  'UnknownFolder': {
    languageEn:
        'Unfortunately, ExLoader does not know where is the files folder for this modification',
    languageRu:
        'К сожалению, ExLoader не знает, где находится папка файлов этой модификации',
    languageUa:
        'На жаль, ExLoader не знає, де знаходиться папка файлів цієї модифікації',
    languagePl:
  ...
  'CloudConfigSystemConfigs': {
    languageEn:
        "This modification uses a cloud config system, you can install them in the modification itself or on it's website!",
    languageRu:
        'Данная модификация использует систему облачных конфигураций, их установка происходит в меню модификации или же на её сайте!',
    languageUa:
        'Дана модифікація використовує систему хмарних конфігурацій, їх установка відбувається в меню модифікації або ж на її сайті!',
    languagePl:
  ...
  'InstallTheGameToOpenFolder': {
    languageEn:
        "You have to install the game to open this modification's files folder",
    languageRu:
        'Для открытия папки файлов этой модификации, тебе необходимо установить игру',
    languageUa:
        'Для відкриття папки файлів цієї модифікації, тобі необхідно встановити игру',
    languagePl:
  ...
  'InstallTheGameToInstallConfigs': {
    languageEn:
        "You have to install the game to download configs for this modification. If the game is already installed, and the error does not disappear, try installing configs while the game process is openned.",
    languageRu:
        'Для установки конфигов к этой модификации, тебе необходимо установить игру. Если игра уже установлена, а ошибка не исчезает - попробуй установить конфиги тогда, когда процесс игры будет открыт.',
    languageUa:
        'Для встановки конфігів до цієї модифікації, тобі необхідно встановити игру. Якщо гра вже встановлена, а помилка не зникає - спробуй встановити конфіги тоді, коли процес гри буде відкрит.',
    languagePl:
  ...
  'SteamIsNotInstalled': {
    languageEn:
        'Failed to disable protection module: You have to install Steam first!',
    languageRu:
        'Не удалось отключить защитный модуль: Для продолжения тебе необходимо установить Steam!',
    languageUa:
        'Не вдалося відключити захисний модуль: для продовження тобі необхідно встановити Steam!',
    languagePl:
  ...
  'VacIsAlreadyDisabled': {
    languageEn:
        'This function is already working! To re-enable VAC-Module restart the steam process',
    languageRu:
        'Модуль VAC уже отключён! Для деактивации перезапусти процесс стима',
    languageUa:
        'Функція відключення модуля VAC вже активна! Для деактивації перезапусти процес стіма',
    languagePl:
  ...
  'FailedToReplaceVACModule': {
    languageEn:
        'Failed to disable protection module: Some unexpected error has happened!',
    languageRu:
        'Не удалось отключить защитный модуль: В ходе замены модуля VAC произошла непредвиденная ошибка!',
    languageUa:
        'Не вдалося відключити захисний модуль: в ході заміни модуля VAC сталася непередбачена помилка!',
    languagePl:
  ...
  'SteamWasNotLaunched': {
    languageEn:
        'Failed to disable protection module: steam process was not relaunched!',
    languageRu:
        'Не удалось отключить защитный модуль: процесс стима не был перезапущен!',
    languageUa:
        'Не вдалося відключити захисний модуль: процес стіма не був перезапущений!',
    languagePl:
  ...
  'VacModuleIsReplaced': {
    languageEn:
        'VAC module has been successfully replaced! To bring everything back just restart the Steam process',
    languageRu:
        'Модуль VAC успешно отключён! Для обратного включения перезапусти процесс стима',
    languageUa:
        'Модуль VAC успішно відключен! Для зворотного включення перезапусти процес стіма',
    languagePl:
  ...
  'AlreadyInList': {
    languageEn:
        "Modification hasn't been added to your library because it's already in it!",
    languageRu:
        'Модификация не была добавлена в твою библиотеку, так как она уже присутствует в ней!',
    languageUa:
        'Модифікація не була додана до твоєї бібліотеки, оскільки вона вже присутня в ній!',
    languagePl:
  ...
  'WaitForLibraryToAdd': {
    languageEn:
        "Wait for ExLoader to analyze your modification and add it to your library!",
    languageRu:
        'Подожди, пока ExLoader обработает твою модификацию и добавит её в библиотеку',
    languageUa:
        'Зачекай, поки ExLoader обробить твою модифікацію і додасть її в бібліотеку',
    languagePl:
  ...
  'WaitForLibraryToUpdate': {
    languageEn:
        "Wait for ExLoader to analyze your modification and update it in your library!",
    languageRu:
        'Подожди, пока ExLoader обработает твою модификацию и обновит её в библиотеке',
    languageUa:
        'Зачекай, поки ExLoader обробить твою модифікацію та оновить її в бібліотеці',
    languagePl:
  ...
  'FailedToUpdateCustomModification': {
    ...
    languageRu: 'Не удалось обновить модификацию с помощью выбранного файла!',
  ...
  'ChooseADllOrExe': {
    ...
    languageRu: 'Выбери файл желаемой модификации',
  ...
  'DeletedSuccessfully': {
    ...
    languageRu: 'Модификация удалена из твоей библиотеки',
  ...
  'ModificationWillBeRemoved': {
    languageEn:
        "The process of removing all the modification's files will be started in five seconds!",
    languageRu:
        'Процесс удаления всех файлов модификации начнётся через пять секунд!',
    languageUa:
        "Процес видалення всіх файлів модифікації почнеться через п'ять секунд!",
    languagePl:
  ...
  'ModificationDeleted': {
    ...
    languageRu: 'Файлы модификации успешно удалены!',
  ...
  'ModificationNotDeleted': {
    ...
    languageRu:
        'ExLoader не обнаружил никаких файлов данной модификации на твоём устройстве!',
    languageUa:
        'ExLoader не виявив жодних файлів даної модифікації на твоєму пристрої!',
    languagePl:
  ...
  'NoSupportLinkIsProvided': {
    languageEn:
        "This modification's developer did not provide any contact link for support!",
    languageRu:
        'Разработчик данной модификации не предоставил ссылки на её техническую поддержку!',
    languageUa:
        "Розробник даної модифікації не надав посилання на її технічну підтримку!",
    languagePl:
  ...
  'CannotOpenThisLink': {
    ...
    languageRu: 'К сожалению, ExLoader не может открыть эту ссылку',
  ...
  'AddingToExclusions': {
    ...
    languageRu: 'Настраиваем защитник Windows',
  ...
  'ReplacingModule': {
    ...
    languageRu: 'Изменяем загрузочный модуль игры',
  ...
  'GoogleAuthPageTitle': {
    ...
    languageRu: "ExLoader - авторизация пройдена",
  ...
  'PreLaunchCheck': {
    ...
    languageRu: 'Предстартовая проверка',
  ...
  'DisableAC': {
    languageEn:
        "Modification's launch process was interrupted due to the presence of an active and working user anti-cheat. Disable all programs like FaceIt, ESEA, EAC, BattleEye, Byfron, Vanguard, MRAC, etc. to continue!",
    languageRu:
        'Запуск модификации был прерван в связи с наличием активного и работающего пользовательского анти-чита. Отключи все программы наподобие FaceIt, ESEA, EAC, BattleEye, Byfron, Vanguard, MRAC и т.д. для продолжения!',
    languageUa:
        "Запуск модифікації був перерван у зв'язку з наявністю активного і працюючого користувальницького анти-чита. Вимкни всі програми на зразок FaceIt, ESEA, EAC, BattleEye, Byfron, Vanguard, MRAC і т.д. для продовження!",
    languagePl:
  ...
  'CmdWasNotFound': {
    languageEn:
        "It seems that your device is missing the command line. To solve this problem, return cmd.exe file to the Windows\\System32 folder on your system drive. Unfortunately, ExLoader won't work properly without such an action on your side.",
    languageRu:
        'Похоже, что на твоём компьютере отсутствует командная строка. Для решения данной проблемы верни файл cmd.exe в папку Windows\\System32 на системном диске. К сожалению, без этого действия, ExLoader не сможет работать корректно.',
    languageUa:
        "Схоже, що на твоєму комп'ютері відсутній командний рядок. Для вирішення даної проблеми поверни файл cmd.exe в папку Windows\\System32 на системному диску. На жаль, без цієї дії, ExLoader не зможе працювати коректно.",
    languagePl:
  ...
  'ComponentsCheckUnified': {
    ...
    languageRu: 'Проверяем наличие компонентов {components}',
    languageUa: 'Перевіряємо наявність компонентів {components}',
    languagePl: 'Sprawdzamy obecność komponentów {components}',
    languageDe: "Wir prüfen das Vorhandensein von {components}-Komponenten",
    languageIt: 'Verifica dell`installazione dei componenti {components}',
    languageTr:
  ...
  'InstallingInjectionModule': {
    ...
    languageRu: 'Установка загрузочного модуля',
  ...
  'InstallingFonts': {
    ...
    languageRu: 'Устанавливаем необходимые шрифты',
  ...
  'InstallingExtraFiles': {
    ...
    languageRu: 'Подготавливаем дополнительные файлы',
  ...
  'UpdatingExtraFiles': {
    ...
    languageRu: 'Обновляем дополнительные файлы',
  ...
  'PreparingProcesses': {
    ...
    languageRu: 'Настраиваем процессы',
  ...
  'WaitingForCSGOLaunch': {
    ...
    languageRu: "Ожидаем, пока ты запустишь {game}",
  ...
  'FailedToLaunchDueToSteam': {
    languageEn:
        "Modification's launch process was interrupted due to the absence of installed Steam on your device. Install Steam and retry to launch the modification to continue!",
    languageRu:
        'Запуск модификации был прерван в связи с отсутствием установленного Steam на твоём устройстве. Для продолжения, установи Steam и повтори попытку!',
    languageUa:
        "Запуск модифікації був перерван у зв'язку з відсутністю встановленого Steam на твоєму пристрої. Для продовження, встанови Steam і повтори спробу!",
    languagePl:
  ...
  'WaitingForSteamLaunch': {
    ...
    languageRu: 'Ожидаем, пока ты запустишь steam',
  ...
  'CheckingModules': {
    ...
    languageRu: 'Проверяем игровые модули',
  ...
  'CreatingModificationFile': {
    ...
    languageRu: 'Создаём загрузочный модуль модификации',
  ...
  'ModificationInjecting': {
    ...
    languageRu: 'Внедряем модуль модификации',
  ...
  'VerifyingFiles': {
    ...
    languageRu: 'Верифицируем установочные файлы',
  ...
  'InstallingModification': {
    ...
    languageRu: 'Установка модификации',
  ...
  'UpdatingModification': {
    ...
    languageRu: 'Обновление модификации',
  ...
  'AnalyzingGameBehaviour': {
    ...
    languageRu: 'Анализируем поведение игры',
  ...
  'UpdateFailed': {
    languageEn:
        'Unfortunately, some error has happened while updating the application, however, you can download the new version by yourself using the button below',
    languageRu:
        'К сожалению, при обновлении приложения произошла ошибка, однако, ты можешь самостоятельно скачать новую версию с помощью кнопки ниже',
    languageUa:
        'На жаль, при оновленні програми сталася помилка, однак, ти можеш самостійно завантажити нову версію за допомогою кнопки нижче',
    languagePl:
  ...
  'UpdateFailedTryManual': {
    languageEn:
        'It seems that an unexpected error has happened during the ExLoader update, however, you can install it manually: just click the button below and drag all files from opened folder to the directory where you have the ExLoader installed!',
    languageRu:
        'Похоже, что при обновлении приложения произошла ошибка, однако, ты можешь обновить его вручную: просто нажми на кнопку ниже и перетащи все файлы из открывшейся папки в ту папку, куда ты устанавливал ExLoader!',
    languageUa:
        'Схоже, що при оновленні програми сталася помилка, однак, ти можеш оновити її вручну: просто натисни на кнопку нижче і перетягни всі файли з відкрившоїся папки в ту папку, куди ти встановлювал ExLoader!',
    languagePl:
  ...
  'MissingAssets': {
    languageEn:
        "It looks like that some of the application's files were not installed during the application's installation process. Unfortunately, you will have to reinstall ExLoader from our official website!",
    languageRu:
        'Похоже, что часть файлов приложения была утеряна при его установке. К сожалению, тебе придётся переустановить ExLoader с нашего официального сайта!',
    languageUa:
        'Схоже, що частина файлів програми була загублена при її установці. На жаль, тобі доведеться перевстановити ExLoader з нашого офіційного сайту!',
    languagePl:
  ...
  'NotForMobile': {
    ...
    languageRu: 'Данный раздел недоступен для мобильных модификаций!',
  ...
  'NoLaunchGuide': {
    languageEn:
        "This modification's developer did not left any specific launch instructions",
    languageRu:
        'Разработчик данной модификации не оставлял неординарных инструкций к её запуску',
    languageUa:
        "Розробник даної модифікації не залишав неординарних інструкцій до її запуску",
    languagePl:
  ...
  'HintsAndTips': {
    ...
    languageRu: 'Подсказки и обучение',
  ...
  'ResetTipsAndHints': {
    ...
    languageRu: 'Сбросить статус подсказок и обучения',
  ...
  'HintsCleared': {
    languageEn:
        "That's it, all the tips and training banners will be shown again!",
    languageRu:
        'Готово, все подсказки и обучающие баннеры будут показаны снова!',
    languageUa:
        'Готово, всі підказки та навчальні банери будуть показані знову!',
    languagePl:
  ...
  'YouUseTheLatestVersion': {
    languageEn:
        "You have the latest update of the application's version {version} installed!",
    languageRu:
  ...
  'YouUseNotTheLatestVersion': {
    languageEn:
        "It may be that you are using not the latest version of the application, as it could not retrieve it's updates data due to the connectivity problems with its server! Your client's version is: {version}.",
    languageRu:
        'Возможно ты используешь не самую последнюю версию приложения, так как оно не смогло проверить наличие актуальных обновлений из-за отсутствия подключения к своему серверу! Версия твоего клиента: {version}.',
    languageUa:
        'Можливо ти використовуєш не саму останню версію програми, так як додаток не зміг перевірити наявність актуальних оновлень через відсутність підключення до свого сервера! Версія твого клієнта: {version}.',
    languagePl:
  ...
  'AppActivity': {
    ...
    languageRu: 'Следы активности модификаций и приложения',
  ...
  'DeleteExLoader': {
    ...
    languageRu: 'Удалить ExLoader и очистить все следы',
  ...
  'HideStatisticsDescription': {
    languageEn:
        "Your statistics and other personal information, except for nickname, status and avatar will be hidden from other users!",
    languageRu:
        'Твоя статистика и другая личная информация, кроме никнейма, статуса и аватарки будет скрыта от других пользователей!',
    languageUa:
        'Твоя статистика та інша особиста інформація, крім нікнейма, статусу і аватарки буде прихована від інших користувачів!',
    languagePl:
  ...
  'OutSocialNetworks': {
    ...
    languageRu: 'Наши социальные сети',
  ...
  'OutSocialNetworksDescription': {
    languageEn:
        "All information about updates, technical works or any problems is published right here!",
    languageRu:
        'Вся информация об обновлениях, тех. работах или же каких-либо проблемах публикуется именно тут!',
    languageUa:
        'Вся інформація про оновлення, тех. роботах або ж будь-яких проблемах публікується саме тут!',
    languagePl:
  ...
  'FailedToCopyClipboardData': {
    ...
    languageRu: 'Не удалось скопировать данные из лог-файла приложения!',
    languageUa: 'Не вдалося скопіювати дані з лог-файлу програми!',
  ...
  'UpdateLink': {
    ...
    languageRu: 'Ссылка на архив с обновлением',
  ...
  'ResetVersion': {
    ...
    languageRu: 'Сбросить версию до текущей',
  ...
  'FailedToLaunchBecauseSteamWasRestarted': {
    languageEn:
        "Failed to launch the modification because you've restarted Steam during the modification's startup process!",
    languageRu:
        'Не удалось запустить модификацию так как ты перезапустил Steam во время процесса запуска модификации!',
    languageUa:
        'Не вдалося запустити модифікацію оскільки ти перезапустив Steam під час процесу запуску модифікації!',
    languagePl:
  ...
  'StartTime': {
    ...
    languageRu: 'Дата начала показов в системе unix',
  ...
  'EndTime': {
    ...
    languageRu: 'Дата окончания показов в системе unix',
  ...
  'MaybeYouWantedToEnter': {
    languageEn:
        "Maybe you meant {mail}? Make sure everything is typed correctly and try again)",
    languageRu:
        'Быть может ты имел ввиду {mail}? Убедись, что всё введено верно и попробуй снова)',
    languageUa:
        'Бути може ти мав на увазі {mail}? Переконайся, що все введено вірно і спробуй знову)',
    languagePl:
  ...
  'NoIMeantIt': {
    ...
    languageRu: 'Нет, я ввёл свой email правильно!',
  ...
  'WaitForAMinute': {
    ...
    languageRu: 'Подожди минуту перед следующей попыткой авторизации!',
    languageUa: 'Зачекай хвилину перед наступною спробою авторизації!',
  ...
  'EmailIsInvalid': {
    languageEn:
        "Unfortunately, we won't be able to send a letter to this email, try using another one!",
    languageRu:
        'К сожалению, мы не сможем отправить письмо на этот почтовый сервис, попробуй использовать другой почтовый ящик!',
    languageUa:
        'На жаль, ми не зможемо відправити лист на цей поштовий сервіс, спробуй використовувати інший поштову скриньку!',
    languagePl:
  ...
  'GoogleAuthIsNotAvailable': {
    languageEn:
        "Unfortunately, Google auth is not available right now, try another authentication method!",
    languageRu:
        'К сожалению, авторизация с помощью Google недоступна в данный момент, попробуй другой способ входа!',
    languageUa:
        'На жаль, авторизація за допомогою Google недоступна в даний момент, спробуй інший спосіб входу!',
    languagePl:
  ...
  'InvalidEmail': {
    ...
    languageRu: 'Используй корректный Email адрес!',
  ...
  'FailedToConnect': {
    ...
    languageRu: 'Не удалось подключиться к серверу приложения',
  ...
  'GoogleAuthHasFailed': {
    languageEn:
        "Unfortunately, ExLoader could not go through the authorization process using your Google account. Try using other authentication methods in the app!",
    languageRu:
        'К сожалению, ExLoader не смог пройти процесс авторизации с помощью твоей учётной записи Google. Попробуй использовать другие способы аутентификации в приложении!',
    languageUa:
        'На жаль, ExLoader не зміг пройти процес авторизації за допомогою твого облікового запису Google. Спробуй використовувати інші способи аутентифікації в додатку!',
    languagePl:
  ...
  'ModificationsFileIsNotChosenYet': {
    ...
    languageRu: 'Файл модификации пока не выбран',
  ...
  'WhichGame': {
    ...
    languageRu: 'К какой игре создана твоя модификация?',
  ...
  'UseGameIcons': {
    ...
    languageRu: 'Используй иконки снизу для выбора игры',
  ...
  'OkayIUnderstand': {
    ...
    languageRu: 'Хорошо, спасибо, я понял!',
  ...
  'FailedToChangeStatus': {
    ...
    languageRu:
        'К сожалению, нам не удалось обновить твой статус. Возможно, что-то в нём не так!',
    languageUa:
        'На жаль, нам не вдалося оновити твій статус, можливо, щось у ньому не так!',
    languagePl:
  ...
  'FailedToChangeAvatar': {
    languageEn:
        "Unfortunately, we were unable to update your avatar, maybe you should choose a different picture!",
    languageRu:
        'К сожалению, нам не удалось обновить твою аватарку, возможно, тебе стоит выбрать другую картинку!',
    languageUa:
        'На жаль, нам не вдалося оновити твою аватарку, можливо тобі варто вибрати іншу картинку!',
    languagePl:
  ...
  'FailedToChangeNickname': {
    languageEn:
        "Unfortunately, we were unable to update your nickname, perhaps, there is something wrong with it!",
    languageRu:
        'К сожалению, нам не удалось обновить твой никнейм. Возможно, что-то в нём не так!',
    languageUa:
        'На жаль, нам не вдалося оновити твій нікнейм, можливо, щось у ньому не так!',
    languagePl:
  ...
  'ProfileInfoIsSaved': {
    ...
    languageRu: 'Информация о профиле успешно обновлена!',
    languageUa: 'Інформацію про профіль успішно оновлено!',
    languagePl: 'Podane informacje o profilu zostały pomyślnie zapisane!',
    languageDe:
        "Die angegebene Profilinformation wurde erfolgreich gespeichert!",
    languageIt:
        'Le informazioni del profilo fornite sono state salvate con successo!',
    languageTr: "Sağlanan profil bilgileri başarıyla kaydedildi!",
    languageEs:
  ...
  'NotEnoughCharacters': {
    languageEn:
        "You have entered too few characters to change this preference!",
    languageRu: 'Ты ввёл слишком мало символов для изменения этой настройки!',
    languageUa: 'Ти ввів занадто мало символів для зміни цього налаштування!',
  ...
  'NotEnoughCharactersForEntity': {
    languageEn:
        "Your {entity} seems to be too short, please, come up with something more original!",
    languageRu:
        'Какой-то слишком короткий {entity} у тебя получился, придумай что-то более оригинальное!',
    languageUa:
        'Якийсь занадто короткий {entity} у тебе вийшов, придумай щось більш оригінальне!',
    languagePl:
        'Masz trochę za krótką {entity}, wymyśl coś bardziej oryginalnego!',
    languageDe:
        "Etwas zu {entity} Feedback hast du bekommen, denke an etwas Originelleres!",
    languageIt:
        'La tua {entity} sembra essere troppo corta, per favore, proponi qualcosa di più originale!',
    languageTr:
        "{entity} çok kısa görünüyor, lütfen daha orijinal bir şey bulun!",
    languageEs:
  ...
  'ChangeWillBeAvailableAt': {
    languageEn:
        "The next change of this preference will be available at {date}!",
    languageRu:
        'Следующее изменение этого параметра будет доступно лишь {date}!',
    languageUa: 'Наступна зміна цього параметра буде доступна тільки {date}!',
  ...
  'FileSizeIsToGross': {
    languageEn:
        "The file size is too gross, try using an avatar with weight of less than 1 megabyte!",
    languageRu:
        'Размер файла слишком велик, попробуй использовать аватарку весом менее 1 мегабайта!',
    languageUa:
        'Розмір файлу занадто велик, спробуй використовувати аватарку вагою менше 1 мегабайта!',
    languagePl:
  ...
  'PremiumDescription': {
    languageEn:
        "A good private modification, that costs cheaper than a cup of coffee!",
    languageRu: 'Хорошая приватная модификация, стоимостью дешевле чашки кофе!',
    languageUa: 'Хороша приватна модифікація, вартістю дешевше чашки кави!',
  ...
  'PopularDescription': {
    ...
    languageRu: 'Одна из самых популярных модификаций к выбранной тобой игре!',
  ...
  'MotEnoughData': {
    ...
    languageRu: 'Недостаточно данных',
    languageUa: 'Недостатньо даних',
  ...
  'MarkAfterUpdate': {
    ...
    languageRu:
        'Ты не можешь ставить оценки модификациям, которые находятся в статусе обновления!',
    languageUa:
        'Ти не можеш ставити оцінки модифікаціям, які знаходяться в статусі оновлення!',
    languagePl:
  ...
  'MarkAfterBuy': {
    languageEn:
        "Purchase this modification and auth in partner's system to be able to set marks!",
    languageRu:
        'Приобрети модификацию и авторизуйся в системе партнёра, чтобы получить доступ к её оцениванию!',
    languageUa:
        "Придбай модифікацію і авторизуйся в системі партнера, щоб отримати доступ до її оцінювання!",
    languagePl:
  ...
  'MarkAfterPlay': {
    languageEn:
        'You will be able to mark to this modification only after you play with it for a while!',
    languageRu:
        'Ты сможешь оценивать эту модификацию только после того, как поиграешь с ней!',
    languageUa:
        'Ти зможеш оцінювати цю модифікацію тільки після того, як пограєш з нею!',
    languagePl:
  ...
  'NoRateInOfflineMode': {
    ...
    languageRu: 'Функция установки рейтинга недоступна в автономном режиме!',
    languageUa:
        'Функція встановлення рейтингу недоступна в автономному режимі!',
    languagePl: 'Funkcja oceniania nie jest dostępna w trybie offline!',
    languageDe: "Die Bewertungsfunktion ist im Offline-Modus nicht verfügbar!",
    languageIt:
  ...
  'UnderUpdate': {
    ...
    languageRu: 'Модификация находится в стадии обновления!',
    languageUa: 'Модифікація перебуває в стадії оновлення!',
    languagePl: 'Modyfikacja w fazie aktualizacji',
    languageDe: "Diese Modifikation der Aktualisierung!",
  ...
  'TemporaryUnavailable': {
    ...
    languageRu: 'Временно недоступно',
  ...
  'NoReviewsInOfflineMode': {
    ...
    languageRu:
        'К сожалению, отправка комментариев недоступна в автономном режиме',
    languageUa:
        'На жаль, надсилання коментарів недоступне в автономному режимі',
    languagePl:
  ...
  'NoSpamPleaseEntity': {
    languageEn:
        "Please, come up with a more informative {entity} that will be useful to other users, hardly anyone is interested in reading spam!",
    languageRu:
        'Придумай более информативный {entity}, который будет полезен другим пользователям. Вряд ли кому-то интересно читать спам!',
    languageUa:
        "Придумай більш інформативний {entity}, який буде корисним іншим користувачам. Навряд чи комусь цікаво читати спам!",
    languagePl:
        'Wymyśl bardziej pouczającą {entity}, która będzie przydatna dla innych użytkowników. Mało kto jest zainteresowany czytaniem spamu!',
    languageDe:
        "Überlegen Sie sich eine informativere {entity}, die für andere Benutzer nützlich sein wird. Kaum jemand interessiert sich für das Lesen von Spam!",
    languageIt:
        'Per favore, crea una {entity} più informativa che sarà utile ad altri utenti, quasi nessuno è interessato a leggere lo spam!',
    languageTr:
        "Lütfen, diğer kullanıcılar için faydalı olacak daha bilgilendirici bir {entity} ile gelin, neredeyse hiç kimse spam okumakla ilgilenmiyor!",
    languageEs:
  ...
  'EntityAdded': {
    ...
    languageRu: '{entity} успешно добавлен',
    languageUa: '{entity} успішно додана',
    languagePl: '{entity} została pomyślnie dodana',
    languageDe: "{entity} wurde erfolgreich hinzugefügt",
    languageIt: '{entity} è stata aggiunta con successo',
  ...
  'EntityEdited': {
    ...
    languageRu: 'Твой {entity} сохранён',
    languageUa: 'Твій {entity} збережено',
    languagePl: 'Twoja {entity} została zapisana',
    languageDe: "Ihre {entity} wurde gespeichert",
    languageIt: 'La vostra {entity} è salvata',
  ...
  'NextEditWillBeAvailableAt': {
    languageEn:
        'You will be able to write a new review or edit the current one only on {date}!',
    languageRu:
        'Ты сможешь написать новый отзыв или же отредактировать текущий лишь {date}!',
    languageUa:
        'Ти зможеш написати новий відгук або ж відредагувати поточний лише {date}!',
    languagePl:
  ...
  'FailedToFindTheModification': {
    languageEn:
        "It looks like this modification has been removed from the application's library",
    languageRu:
        'Похоже, что эта модификация была удалена из библиотеки приложения',
    languageUa: 'Здається, ця модифікація була видалена з бібліотеки ExLoader',
    languagePl:
  ...
  'PleaseUseValidUrl': {
    languageEn:
        "Use an appropriate profile link following one of these «format1» «format2» formats!",
    languageRu:
        'Используй корректную ссылку профиля в формате «format1» или же «format2»!',
    languageUa:
        'Використовуй коректне посилання профілю в форматі ««format1» або ж ««format12»!',
    languagePl:
        'Użyj poprawnego linku do profilu w formacie ««format1» lub ««format2»!',
    languageDe:
        'Verwenden Sie den korrekten Profillink im Format «format1» oder «format2»!',
    languageIt:
        'Utilizza il collegamento al profilo corretto nel formato «format1» o «format2»!',
    languageTr:
        "Bu «format1» «format2» formatlarından birini takip eden uygun bir profil bağlantısı kullanın!",
    languageEs:
  ...
  'YouAreTemporaryBannedInReviewsOrConfigs': {
    languageEn:
        "It seems that you have tried to write a review, or upload or edit a configuration using an uninformative, spam, advertising, or deceptive content too often! In order to save you from moderator's ban, the auto-check system temporarily restricted your access to the writing comments and configuration's uploading or editing features! Your ban expires on {date}.",
    languageRu:
        'Похоже, что ты слишком часто пытался написать отзыв или же загрузить конфигурацию, используя неинформативное, спамовое, рекламное либо же обманное содержание! Дабы модерация не забанила тебя за подобные действия, система автопроверки временно ограничила твой доступ к функционалу написания комментариев и к загрузке или же редактированию конфигураций! Срок действия бана истекает {date}.',
    languageUa:
        "Схоже, що ти занадто часто намагался написати відгук або завантажити чи відредагувати конфігурацію, використовуючи неінформативний, спамовий, рекламний або ж обманний зміст! Щоб модерація не забанила тебе за подібні дії, система автоперевірки тимчасово обмежила твій доступ до функціоналу написання коментарів та завантаження чи редагування конфігурацій! Термін дії бана закінчується {date}.",
    languagePl:
  ...
  'YourEntityIsTheSame': {
    languageEn:
        "To edit your {entity}, you need to change at least something in it so that it differs from the previous review!",
    languageRu:
        'Чтобы отредактировать {entity} тебе необходимо изменить в нём хоть что-то, чтобы он отличался от предыдущего отзыва!',
    languageUa:
        "Щоб відредагувати {entity} тобі необхідно змінити в ньому хоч щось, щоб він відрізнявся від попереднього відгука!",
    languagePl:
        'Aby edytować {entity}, musisz coś w nim zmienić, aby różnił się od poprzedniej recenzji!',
    languageDe:
        "Um einen {entity} zu bearbeiten, müssen Sie mindestens etwas daran ändern, damit er sich von der vorherigen Bewertung unterscheidet!",
    languageIt:
        'Per modificare un {entity}, devi cambiare almeno qualcosa al riguardo per renderlo diverso dalla recensione precedente!',
    languageTr:
        "{entity}'nizi düzenlemek için, önceki incelemeden farklı olması için en azından içindeki bir şeyi değiştirmeniz gerekir!",
    languageEs:
  ...
  'NetworkIssue': {
    languageEn:
        "Failed to receive data from the application's server: «Try turning on some VPN, for example, 4ebur.net, to solve this problem!». \n\nDon't worry, you won't have use this VPN every time you launch the app, once you open any mod, the ExLoader will cache all data and you will be able to launch this mod without VPN! Don't forget to turn on your VPN once a week to check for updates of your favourite mod!\n\nThe cause of the error is most likely in your internet provider or in some firewall app that blocks our app's traffic.\n\nAnd if the problem is on our side, we always tell about it in our {Social} channel, that can be opened with the button below!",
    languageRu:
        'Не удалось получить данные с сервера приложения: «Попробуй использовать VPN, например, 4ebur.net, для решения этой проблемы!». \n\nНе переживай, каждый раз включать VPN тебе не придётся, после первого запуска необходимого мода приложение закэширует все данные и ты сможешь запускать этот мод без VPN. В дальнейшем просто включай впн примерно раз в неделю для проверки обновлений любимого мода!\n\nПричина ошибки, скорее всего, кроется в твоём интернет-провайдере или же в каком-то приложении-файерволе, которое блокирует трафик нашего приложения.\n\nА если вдруг проблема на нашей стороне, то мы всегда сообщаем об этом в нашем {Social} канале, доступном по кнопке ниже!',
    languageUa:
        'Не вдалося отримати дані з сервера застосунку: «Спробуй використати VPN, наприклад, 4ebur.net, для вирішення цієї проблеми!». \n\nНе переживай, щоразу вмикати VPN тобі не доведеться, після першого запуску необхідного мода застосунок закешує всі дані і ти зможеш запускати цей мод без VPN. Надалі просто вмикай впн приблизно раз на тиждень для перевірки оновлень улюбленого мода!\n\nПричина помилки, найімовірніше, криється у твоєму інтернет-провайдері або ж у якомусь застосунку-фаєрволі, який блокує трафік нашого застосунку.\n\nА якщо раптом проблема на нашому боці, то ми завжди повідомляємо про це в нашому {Social} каналі, доступному за кнопкою нижче!',
    languagePl:
        'Nie udało się odebrać danych z serwera aplikacji: «Spróbuj włączyć jakiś VPN, na przykład 4ebur.net, aby rozwiązać ten problem!». \n\nNie martw się, nie będziesz musiał używać tego VPN za każdym razem, gdy uruchomisz aplikację, po otwarciu dowolnego moda, ExLoader zbuforuje wszystkie dane i będziesz mógł uruchomić ten mod bez VPN! Nie zapomnij włączyć VPN raz w tygodniu, aby sprawdzić aktualizacje swojego ulubionego moda!\n\nPrzyczyna błędu leży najprawdopodobniej po stronie dostawcy Internetu lub zapory sieciowej, która blokuje ruch naszej aplikacji.\n\nA jeśli problem leży po naszej stronie, zawsze informujemy o tym na naszym kanale {Social}, który można otworzyć za pomocą przycisku poniżej!',
    languageDe:
        "Es konnten keine Daten vom Server der Anwendung empfangen werden: «Versuchen Sie, ein VPN einzuschalten, zum Beispiel 4ebur.net, um dieses Problem zu lösen»!. \n\nKeine Sorge, Sie müssen dieses VPN nicht jedes Mal verwenden, wenn Sie die App starten. Sobald Sie eine Mod öffnen, wird der ExLoader alle Daten zwischenspeichern und Sie werden in der Lage sein, diese Mod ohne VPN zu starten!\n\nVergessen Sie nicht, Ihr VPN einmal pro Woche einzuschalten, um nach Updates für Ihren Lieblingsmod zu suchen! Die Ursache des Fehlers liegt höchstwahrscheinlich bei deinem Internet-Provider oder bei einer Firewall-App, die den Datenverkehr unserer App blockiert.\n\nUnd wenn das Problem auf unserer Seite liegt, berichten wir immer darüber in unserem {Social} Kanal, der mit dem Button unten geöffnet werden kann!",
    languageIt:
        "Impossibile ricevere dati dal server dell'applicazione: «Prova ad attivare una VPN, ad esempio 4ebur.net, per risolvere questo problema!». \n\nNon preoccupatevi, non dovrete usare questa VPN ogni volta che avviate l'app, una volta aperta una mod, ExLoader metterà in cache tutti i dati e potrete avviare questa mod senza VPN!\n\nNon dimenticate di attivare la VPN una volta alla settimana per controllare gli aggiornamenti della vostra mod preferita! La causa dell'errore è molto probabilmente da ricercare nel vostro provider internet o in qualche firewall che blocca il traffico della nostra app.\n\nE se il problema è da parte nostra, ne parliamo sempre nel nostro canale {Social}, che può essere aperto con il pulsante qui sotto!",
    languageTr:
        "Uygulamanın sunucusundan veri alınamadı: «Bu sorunu çözmek için 4ebur.net gibi bir VPN açmayı deneyin!». \n\nEndişelenmeyin, uygulamayı her başlattığınızda bu VPN'i kullanmak zorunda kalmayacaksınız, herhangi bir modu açtığınızda, ExLoader tüm verileri önbelleğe alacak ve bu modu VPN olmadan başlatabileceksiniz!\n\nFavori modunuzun güncellemelerini kontrol etmek için VPN'inizi haftada bir kez açmayı unutmayın! Hatanın nedeni büyük olasılıkla internet sağlayıcınız veya uygulamamızın trafiğini engelleyen bazı güvenlik duvarı uygulamalarıdır.\n\nVe eğer sorun bizim tarafımızdaysa, bunu her zaman aşağıdaki düğmeyle açılabilen {Social} kanalımızda anlatıyoruz!",
    languageEs:
        "Error al recibir datos del servidor de la aplicación: «¡Prueba a activar alguna VPN, por ejemplo, 4ebur.net, para solucionar este problema!». \n\nNo te preocupes, no tendrás que utilizar esta VPN cada vez que inicies la aplicación, una vez que abras cualquier mod, el ExLoader almacenará en caché todos los datos y podrás iniciar este mod sin VPN.\n\nNo olvides activar tu VPN una vez a la semana para comprobar si hay actualizaciones de tu mod favorito. Lo más probable es que la causa del error esté en tu proveedor de Internet o en alguna aplicación de cortafuegos que bloquea el tráfico de nuestra aplicación.\n\nY si el problema es nuestro, siempre lo contamos en nuestro canal {Social}, ¡que puedes abrir con el botón de abajo!",
    languageCn:
        "无法从应用程序服务器接收数据： «试着打开一些 VPN，例如 4ebur.net 来解决这个问题！»。 \n\n别担心，你不必每次启动应用程序时都使用 VPN，一旦你打开任何 mod，ExLoader 就会缓存所有数据，这样你就可以在没有 VPN 的情况下启动此 mod 了！别忘了每周打开一次 VPN，检查您喜爱的 MOD 是否有更新！出现错误的原因很可能是您的网络提供商或防火墙应用程序阻止了我们应用程序的流量。\n\n如果问题出在我们这边，我们会在我们的 {Social} 频道上公布，您可以通过下面的按钮打开该频道！",
  },
  'UnstableModification': {
    languageEn:
        "According to our data, about {user} {percent} of users of this modification have faced the game crashing issue during this day! If the game has not been recently updated, it means that this modification is terribly optimized for different systems, and most likely you may encounter various problems while using it",
    languageRu:
        'Судя по нашим данным, около {user} {percent} пользователей этой модификации столкнулись с проблемой вылета игры за сегодняшний день! Если в недавнее время не выходило каких-либо обновлений игры, значит, эта модификация ужасно оптимизирована под работу на разных системах, и, вероятнее всего, ты можешь столкнуться с различными проблемами при её использовании',
    languageUa:
        "Судячи з наших даних, близько {user} {percent} користувачів цієї модифікації зіткнулися з проблемою вильоту гри за сьогоднішній день! Якщо в недавній час не виходило будь-яких оновлень гри, значить, ця модифікація жахливо оптимізована під роботу на різних системах, і, найімовірніше, ти можеш зіткнутися з різними проблемами при її використанні",
    languagePl:
        'Według naszych danych, około {user} {percent} użytkowników tej modyfikacji napotkało dziś problem z zawieszaniem się gry! Jeśli ostatnio w grze nie pojawiły się żadne aktualizacje, oznacza to, że ta modyfikacja jest źle zoptymalizowana pod kątem pracy na różnych systemach i najprawdopodobniej możesz napotkać problemy podczas korzystania z niej',
    languageDe:
        "Unseren Daten zufolge sind etwa {user} {percent} der Benutzer dieser Modifikation heute auf das Problem des Absturzes des Spiels gestoßen! Wenn es in letzter Zeit keine Updates für das Spiel gab, dann ist dieser Mod schrecklich für verschiedene Systeme optimiert, und höchstwahrscheinlich können Sie bei der Verwendung auf verschiedene Probleme stoßen",
    languageIt:
        "Secondo i nostri dati, circa {user} {percent} di utenti di questa modifica hanno affrontato il problema del crash del gioco durante questa giornata! Se il gioco non è stato aggiornato di recente, significa che questa modifica è terribilmente ottimizzata per i diversi sistemi e molto probabilmente potreste riscontrare diversi problemi durante l'utilizzo.",
    languageTr:
        "Verilerimize göre, bu modifikasyonun kullanıcılarından yaklaşık {user} {percent} bu gün boyunca oyunun çökmesi sorunuyla karşılaştı! Oyun yakın zamanda güncellenmediyse, bu modifikasyonun farklı sistemler için korkunç derecede optimize edildiği anlamına gelir ve büyük olasılıkla kullanırken çeşitli sorunlarla karşılaşabilirsiniz",
    languageEs:
  ...
  'StableModification': {
    languageEn:
        "According to our data, about {user} {percent} of users of this modification have faced the game crashing issue during this day! This is a great indicator, that shows that the mod is working well and stable.",
    languageRu:
        'Судя по нашим данным, около {user} {percent} пользователей этой модификации столкнулись с проблемой вылета игры за сегодняшний день! Это хороший показатель, означающий хорошую и стабильную работу мода.',
    languageUa:
        "Судячи з наших даних, близько {user} {percent} користувачів цієї модифікації зіткнулися з проблемою вильоту гри за сьогоднішній день!Це хороший показник, що означає хорошу і стабільну роботу мода.",
    languagePl:
        'Według naszych danych, około {user} {percent} użytkowników tej modyfikacji napotkało dziś problem z zawieszaniem się gry!Jest to dobry wskaźnik, oznaczający, że mod działa dobrze i stabilnie.',
    languageDe:
        "Unseren Daten zufolge sind etwa {user} {percent} der Benutzer dieser Modifikation heute auf das Problem des Absturzes des Spiels gestoßen! Dies ist ein guter Indikator dafür, dass der Mod gut und stabil funktioniert.",
    languageIt:
        "Secondo i nostri dati, circa {user} {percent} degli utenti di questa modifica ha affrontato il problema del crash del gioco durante questa giornata! Questo è un ottimo indicatore, che dimostra che la modifica funziona bene ed è stabile.",
    languageTr:
        "Verilerimize göre, bu modifikasyonun kullanıcılarının yaklaşık {user} {percent}'i bu gün boyunca oyunun çökmesi sorunuyla karşılaştı! Bu, modun iyi ve kararlı çalıştığını gösteren harika bir göstergedir.",
    languageEs:
  ...
  'LibraryWithSuchTagIsEmpty': {
    languageEn:
        "It seems that there are no modifications with such a tag in ExLoader's library",
    languageRu:
        'Похоже, что в библиотеке ExLoader нет модификаций с таким тэгом',
    languageUa:
        'Здається, що в бібліотеці ExLoader немає модифікацій з таким тегом',
    languagePl:
  ...
  'PressToCheckTheSource': {
    ...
    languageRu: 'Нажми, чтобы перейти к\nисточнику проверки модификации.',
    languageUa: 'Натисни, щоб перейти до\nджерела перевірки модифікації.',
    languagePl: 'Kliknij, aby przejść do\nźrodła sprawdzania modyfikacji.',
    languageDe: "Klicken Sie hier, um zur\nMod-Check-Quelle zu gelangen.",
    languageIt: 'Fai clic qui per accedere\nalla fonte dei controllo mod.',
  ...
  'NoText': {
    ...
    languageRu: 'Кажется кто-то украл текст этого комментария',
  ...
  'CanNotVoteInOfflineMode': {
    languageEn:
        'Unfortunately, you can not rate a review or configuration in an offline mode',
    languageRu:
        'К сожалению, оценка отзывов и конфигураций недоступна в автономном режиме',
    languageUa:
        'На жаль, оцінка відгуків та конфігурацій недоступна в автономному режимі',
    languagePl:
  ...
  'VoteIsDelayed': {
    languageEn:
        "To avoid spam, you can will able able to change or set new vote only within half a minute",
    languageRu:
        'Во избежание спама ты сможешь изменить или же поставить новую оценку лишь через пол минуты',
    languageUa:
        'Щоб уникнути спаму ти зможеш змінити або ж поставити нову оцінку лише через пів хвилини',
    languagePl:
  ...
  'ThisReviewWasEdited': {
    ...
    languageRu: 'Этот комментарий был отредактирован после публикации!',
  ...
  'LowRating': {
    ...
    languageRu: 'У этого отзыва слишком низкий рейтинг. Нажми, что прочитать',
    languageUa:
        'У цього відгука занадто низький рейтинг. Натисни, що прочитати',
  ...
  'TranslateToShort': {
    ...
    languageRu: 'Перевести на {language} язык',
  ...
  'YourEntityWasDeleted': {
    languageEn:
        "It looks like that someone has deleted your {entity}. If it wasn't you, then your comment violated ExLoader's rules and was removed by our moderation staff!",
    languageRu:
        'Похоже, что твой {entity} кто-то удалил . Если это сделал не ты, значит твой комментарий нарушил правила ExLoader и был удалён модерацией!',
    languageUa:
        'Схоже, що твій {entity} хтось видалив. Якщо це зробив не ти, значить твій коментар порушив правила ExLoader і був видален модерацією!',
    languagePl:
        'Wygląda na to, że ktoś usunął Twoją {entity}. Jeśli to nie ty, oznacza to, że Twój komentarz naruszył zasady Exloadera i został usunięty przez moderatorów!',
    languageDe:
        "Anscheinend hat jemand deine {entity} gelöscht. Wenn Sie es nicht getan haben, dann hat Ihr Kommentar gegen die Regeln von ExLoader verstoßen und wurde von den Moderatoren gelöscht!",
    languageIt:
        'A quanto pare qualcuno ha cancellato la tua {entity}. Se non l`hai fatto, il tuo commento ha violato le regole di ExLoader ed è stato cancellato dai moderatori!',
    languageTr:
        "Görünüşe göre birisi {entity}'nizi silmiş. Eğer siz değilseniz, yorumunuz ExLoader'ın kurallarını ihlal etmiş ve moderasyon ekibimiz tarafından kaldırılmıştır!",
    languageEs:
  ...
  'BuyToAddReply': {
    languageEn:
        "You can add reviews or responses to premium modifications only after purchase them!",
    languageRu:
        'Добавление отзывов или же ответов к премиум модификациям доступно только после их покупки!',
    languageUa:
        'Додавання відгуків або ж відповідей до преміум модифікацій доступно тільки після їх покупки!',
    languagePl:
  ...
  'WaitForUpdateToAddReview': {
    languageEn:
        "In order to avoid spam, adding new reviews feature for modifications that are being under update is disabled",
    languageRu:
        'Во избежание спама, возможность добавления новых отзывов к модификациям, которые находятся в статусе обновление отключена',
    languageUa:
        'Щоб уникнути спаму, можливість додавання нових відгуків до модифікацій, які знаходяться в статусі оновлення відключена',
    languagePl:
  ...
  'AccessLevel0': {
    ...
    languageRu: 'Обычный пользователь',
  ...
  'AccessLevel1WithName': {
    ...
    languageRu: 'Создатель модификации {modification}',
  ...
  'AccessLevel2': {
    ...
    languageRu: 'Разработчик SwiftSoft',
  ...
  'AccessLevel6': {
    ...
    languageRu: 'Разработчик приложения',
  ...
  'AccessLevel': {
    ...
    languageRu: 'Уровень доступа пользователя',
  ...
  'NotificationsAboutSteamGamesUpdates': {
    ...
    languageRu: 'Уведомлять об обновлении игр Steam',
  ...
  'NotificationsAboutSteamGamesUpdatesDescription': {
    languageEn:
        "If an update has been released for the game you are trying to select the modification for, you will receive an appropriate notification",
    languageRu:
        'Если к игре, модификацию к которой ты пытаешься запустить, вышло обновление, ты получишь соответствующее уведомление',
    languageUa:
        'Якщо до гри, модифікацію до якої ти намагаєшся запустити, вийшло оновлення, ти отримаєш відповідне повідомлення',
    languagePl:
  ...
  'Ban': {
    ...
    languageRu: 'Выдача и снятие бана',
  ...
  '1Day': {
    ...
    languageRu: 'Выдать бан на один день',
  ...
  '3Days': {
    ...
    languageRu: 'Выдать бан на три дня',
  ...
  '7Days': {
    ...
    languageRu: 'Выдать бан на семь дней',
  ...
  '30Days': {
    ...
    languageRu: 'Выдать бан на один месяц',
  ...
  'ResetNickname': {
    ...
    languageRu: 'Сбросить никнейм пользователя',
  ...
  'ResetAvatar': {
    ...
    languageRu: 'Сбросить аватарку пользователя',
  ...
  'ResetStatus': {
    ...
    languageRu: 'Сбросить статус пользователя',
  ...
  'ResetSocials': {
    ...
    languageRu: 'Сбросить социальные сети пользователя',
  ...
  'SomethingWentWrong': {
    ...
    languageRu: 'Упс.... Кажется что-то пошло не так',
  ...
  'AntivirusIsBad': {
    languageEn:
        'Unfortunately, your antivirus program or firewall does not allow ExLoader to download necessary files. To continue, check your antivirus and firewall software settings and try again!',
    languageRu:
        'К сожалению, твоя антивирусная программа или брандмауэр не даёт ExLoader загрузить необходимые файлы. Для продолжения, проверь настройки своего антивирусного и брандмауэрного программного обеспечения, и повтори попытку!',
    languageUa:
        'На жаль, твоя антивірусна програма або брандмауер не дає ExLoader завантажити необхідні файли. Для продовження, перевір налаштування свого антивірусного і брандмауерного програмного забезпечення, і повтори спробу!',
    languagePl:
  ...
  'PossibleAntivirusList': {
    languageEn:
        'The list of possible software which could make this error happen',
    languageRu:
        'Список возможного программного обеспечения, которое могло повлиять на возникновение этой ошибки',
    languageUa:
        'Список можливого програмного забезпечення, яке могло вплинути на виникнення цієї помилки',
    languagePl:
  ...
  'CanNotLaunchInOfflineMode': {
    languageEn:
        "Unfortunately, you can not launch this modification in an offline mode. Wait until ExLoader can reach it's server and try to launch it again!",
    languageRu:
        'К сожалению, ты не сможешь запустить эту модификацию в автономном режиме. Дождись, пока приложение сможет подключиться к своему серверу и повтори попытку запуска нужной тебе модификации!',
    languageUa:
        'На жаль, ти не зможеш запустити цю модифікацію в автономному режимі. Дочекайся, поки ExLoader зможе підключитися до свого сервера і повтори спробу запуску потрібної тобі модифікації!',
    languagePl:
  ...
  'CanNotUseThisFunctionInOfflineMode': {
    languageEn:
        "Unfortunately, you can not perform this operation in an offline mode. Wait until ExLoader can reach it's server and try to do it again!",
    languageRu:
        'К сожалению, ты не можете выполнить это действие в автономном режиме. Дождись, пока приложение сможет подключиться к своему серверу и повтори попытку!',
    languageUa:
        'На жаль, ти не зможеш виконати цю дію в автономному режимі. Дочекайся, поки ExLoader зможе підключитися до свого сервера і спробуй ще раз!',
    languagePl:
  ...
  'GameWasClosedDuringInjection': {
    languageEn:
        "Modification's launch process was interrupted due to the game closing during injection process!",
    languageRu:
        'Запуск модификации был отменён в связи с закрытием игры во время процесса инъекции!',
    languageUa:
        "Запуск модифікації був скасований у зв'язку із закриттям гри під час процесу ін'єкції!",
    languagePl:
  ...
  'CrashMessageCustom': {
    languageEn:
        "It seems that the modification you have tried to launch has causes a game crash! Note, that it's not the ExLoader problem, but the modification's itself, selected in application's settings injection method, or your device's issue. For more information click the button below!",
    languageRu:
        'Похоже, что выбранная тобой модификация привела к вылету игры. Учти, что это не проблема ExLoader, а проблема самой модификации, несовместимого способа инъекции, который ты можешь изменить в настройках приложения, или же твоего устройства. Получи подробный анализ с помощью кнопки ниже!',
    languageUa:
        "Схоже, що обрана тобою модифікація призвела до вильоту гри. Врахуй, що це не проблема ExLoader, а проблема самої модифікації, несумісного способу ін'єкції, який ти можеш змінити в налаштуваннях програми, або ж твого пристрою. Отримай детальний аналіз за допомогою кнопки нижче!",
    languagePl:
  ...
  'ABitOfInformation': {
    ...
    languageRu: 'Немного информации от разработчика',
  ...
  'DoNotShowAgain': {
    ...
    languageRu: 'не показывать снова',
  ...
  'ComponentsInstalling': {
    ...
    languageRu: 'Установка важных компонентов',
  ...
  'FailedToInstallComponents': {
    languageEn:
        'Unfortunately, we were unable to install {entity} components in an automatic mode, however, you can try doing it by yourself with the help of the internet! Version you need is: ',
    languageRu:
        'К сожалению, нам не удалось установить компоненты {entity} в автоматическом режиме, однако, ты можешь попробовать сделать это вручную с помощью любого сайта в интернете! Необходимая версия: ',
    languageUa:
        'На жаль, нам не вдалося встановити компоненти {entity} в автоматичному режимі, однак, ти можеш спробувати зробити це вручну за допомогою будь-якого сайту в інтернеті! Необхідна версія: ',
    languagePl:
        'Niestety, nie udało nam się automatycznie zainstalować komponentów {entity}, jednak możesz spróbować zrobić to ręcznie, korzystając z dowolnej witryny w Internecie! Wymagana wersja: ',
    languageDe:
        "Leider konnten wir die {entity}-Komponenten nicht automatisch installieren, aber Sie können versuchen, dies manuell über eine beliebige Website im Internet zu tun! Benötigte Version: ",
    languageIt:
        'Sfortunatamente non siamo riusciti a installare automaticamente i componenti {entity}, ma puoi provare a farlo manualmente da qualsiasi sito Web su Internet! Versione richiesta: ',
    languageTr:
        "Ne yazık ki, {entity} bileşenlerini otomatik modda yükleyemedik, ancak internet yardımıyla kendiniz yapmayı deneyebilirsiniz! İhtiyacınız olan sürüm: ",
    languageEs:
  ...
  'LaunchProcessIsFinished': {
    ...
    languageRu: 'Модификация успешно запущена',
  ...
  'InstallationIsFinished': {
    languageEn: 'Modification is ready to use',
    languageRu: 'Модификация установлена',
  ...
  'IHaveAProblem': {
    ...
    languageRu: 'У меня проблема, помогите',
  ...
  'ConfigsInstallation': {
    languageEn:
        "You can install pre-made configurations from other users using the gear button on the modification's page!\n\nHowever, some modifications do not support this feature for one reason or another!",
    languageRu:
        'Установка готовых конфигураций от других пользователей доступна с помощью кнопки-шестерёнки на странице модификации!\n\nОднако, существуют модификации, которые не поддерживают эту функцию по тем или иным причинам!',
    languageUa:
        'Установка готових конфігурацій від інших користувачів доступна за допомогою кнопки-шестерінки на сторінці модифікації!\n\nОднак, існують модифікації, які не підтримують цю функцію з тих чи інших причин!',
    languagePl:
  ...
  'WeOfferYouYandex': {
    languageEn:
        'We suggest you to install fast, simple and convenient Yandex Browser for comfortable work on the internet.',
    languageRu:
        'Мы предлагаем тебе установить быстрый, простой и удобный Яндекс Браузер для комфортной работы в интернете.',
    languageUa:
        'Ми пропонуємо тобі встановити швидкий, простий і зручний Яндекс Браузер для комфортної роботи в інтернеті.',
    languagePl:
  ...
  'WeOfferYouYandexButNotBrowser': {
    languageEn:
        'We suggest you to install Yandex extensions for browsers and settings for quick access to Yandex search and services.',
    languageRu:
        'Мы предлагаем тебе установить расширения Яндекса для браузеров, а так-же настройки быстрого доступа к поиску и сервисам Яндекса.',
    languageUa:
        'Ми пропонуємо тобі встановити розширення Яндекса для браузерів, а також налаштування швидкого доступу до пошуку і сервісів Яндекса.',
    languagePl:
  ...
  'WeOfferYouOpera': {
    languageEn:
        'We suggest you to install fast, secure, and easy to use opera browser, complete with a built-in ad blocker, battery saver, and free VPN.',
    languageRu:
        'Мы предлагаем тебе установить быстрый, безопасный и простои браузер Opera со встроенной блокировкой рекламы, экономией заряда батареи и бесплатным VPN.',
    languageUa:
        'Ми пропонуємо тобі встановити швидкий, безпечний і простої браузер Opera з вбудованою блокуванням реклами, економією заряду батареї і безкоштовним VPN',
    languagePl:
  ...
  'WeOfferYouToUpdateOpera': {
    languageEn:
        'We suggest you to update your fast, secure, and easy to use opera browser, complete with a built-in ad blocker, battery saver, and free VPN.',
    languageRu:
        'Мы предлагаем тебе обновить твой быстрый, безопасный и простои браузер Opera со встроенной блокировкой рекламы, экономией заряда батареи и бесплатным VPN.',
    languageUa:
        'Ми пропонуємо тобі оновити твій швидкий, безпечний і простої браузер Opera з вбудованою блокуванням реклами, економією заряду батареї і безкоштовним VPN',
    languagePl:
  ...
  'Agreement': {
    languageEn:
        'By clicking «{button_name}» and installing the recommended by ExLoader software, you agree to the license terms and conditions of the license agreement of the',
    languageRu:
        'Нажимая «{button_name}» и устанавливая рекомендуемое ExLoader программное обеспечение, вы соглашаетесь с лицензионным соглашением',
    languageUa:
        'Натискаючи «{button_name}» та встановлюючи рекомендоване ExLoader програмне забезпечення, ви погоджуєтеся з ліцензійною угодою',
    languagePl:
  ...
  'DesktopSoftware': {
    ...
    languageRu: 'настольного ПО Яндекса',
  ...
  'DoNotForgetToMark': {
    ...
    languageRu: 'Не забудь оценить модификацию после игры!',
  ...
  'OperaAgreeFinal': {
    languageEn:
        'By clicking «{button_name}» you agree to install Opera and consent to its',
    languageRu:
        'Нажимая «{button_name}» вы соглашаетесь установить Opera и принимаете условия',
    languageUa:
        'Натискаючи «{button_name}» ви погоджуєтеся встановити Opera і приймаєте умови',
    languagePl:
  ...
  'OperaAgreeFinalButUpdate': {
    languageEn:
        'By clicking «{button_name}» you agree to update Opera and consent to its',
    languageRu:
        'Нажимая «{button_name}» вы соглашаетесь обновить Opera и принимаете условия',
    languageUa:
        'Натискаючи «{button_name}» ви погоджуєтеся оновити Opera і приймаєте умови',
    languagePl:
  ...
  'OperaLicense': {
    ...
    languageRu: 'Лицензионного соглашения с конечным пользователем',
  ...
  'OperaPrivacy': {
    ...
    languageRu: 'Политики конфиденциальности',
  ...
  'OperaEnding': {
    languageEn:
        'This software can be removed anytime via the add/remove programs utility.',
    languageRu:
        'Эту программу можно в любой момент удалить с помощью инструмента установки/удаления программ.',
    languageUa:
        'Цю програму можна в будь-який момент видалити за допомогою інструменту установки/видалення програм.',
    languagePl:
  ...
  'LaunchIsInLauncher': {
    languageEn:
        'The modification can be launched using your Minecraft launcher, for which this modification was installed.\n\nJust open the loader, choose new version of the client, click «Play» and enjoy the gameplay!',
    languageRu:
        'Запуск модификации осуществляется с помощью твоего лаунчера Minecraft, в который и была установлена эта модификация.\n\nПросто открой лоадер, выбери новую версию клиента, нажми «Играть» и наслаждайся игровым процессом!',
    languageUa:
        'Запуск модифікації здійснюється за допомогою твого лаунчер Minecraft, в який і була встановлена ця модифікація.\n\nПросто відкрий лоадер, вибери нову версію клієнта, натисни «Грати» і насолоджуйся ігровим процесом!',
    languagePl:
  ...
  'NextLoader': {
    languageEn:
        "The initial launch process has been successfully completed, however, this modification has its own loader, which will continue it's further launch process!",
    languageRu:
        'Первоначальный процесс запуска модификации успешно завершён, однако, эта модификация имеет свой собственный лоадер, который продолжит её дальнейший запуск!',
    languageUa:
        'Початковий процес запуску модифікації успішно завершено, однак, ця модифікація має свій власний лоадер, який продовжить її подальший запуск!',
    languagePl:
  ...
  'AuthNeeded': {
    languageEn:
        "🔐 Modification's launcher requires an authorization? Just use the data you have provided during the purchase process!",
    languageRu:
        '🔐 Лаунчер модификации требует авторизации? Ничего страшного - просто используй те данные, которые ты указывал при её покупке!',
    languageUa:
        '🔐 Лаунчер модифікації вимагає авторизації? Нічого страшного - просто використовуй ті дані, які ти вказував при її покупці!',
    languagePl:
  ...
  'Launching': {
    ...
    languageRu: 'Модификация запускается',
  ...
  'WaitForDownloadingToComplete': {
    ...
    languageRu:
        'К сожалению, ты не можешь отменить запуск модификации во время загрузки её файлов. Дождись окончания процесса установки модификации и повтори попытку!',
    languageUa:
        'На жаль, ти не можеш скасувати запуск модифікації під час завантаження її файлів. Дочекайся закінчення процесу установки модифікації і спробуй ще раз!',
    languagePl:
  ...
  'NotAvailableOnLaunch': {
    ...
    languageRu: 'Функция удаления модификации недоступна во время её запуска!',
    languageUa: 'Функція видалення модифікації недоступна під час її запуску!',
    languagePl:
  ...
  'AuthWithGoogle': {
    ...
    languageRu: 'Авторизоваться с помощью Google',
  ...
  'ConfirmDescription': {
    languageEn:
        'Confirm the authorization with the button that we have sent to',
    languageRu:
        'Подтверди авторизацию с помощью кнопки в письме, которое мы отправили на почту',
    languageUa:
        "Підтвердь авторизацію за допомогою кнопки в листі, який ми відправили на пошту",
    languagePl:
  ...
  'ConfirmAuthWithPageInBrowser': {
    languageEn:
        "Confirm authorization using the page that we have opened in your browser. By the way, we've copied the auth link to your clipboard!",
    languageRu:
        'Подтверди авторизацию с помощью страницы, которую мы открыли в твоём браузере. Кстати, ссылка на страницу авторизации дополнительно скопирована в твой буфер обмена!',
    languageUa:
        'Підтверди авторизацію за допомогою сторінки, яку ми відкрили у твоєму браузері. До речі, посилання на сторінку авторизації додатково скопійовано в твій буфер обміну!',
    languagePl:
  ...
  'AlmostLaunched': {
    ...
    languageRu: 'Остался ещё один шаг',
  ...
  'ConfirmingYourIdentity': {
    ...
    languageRu: 'Синхронизируем твой профиль с сервером',
  ...
  'SyncingLibrary': {
    ...
    languageRu: 'Синхронизируем библиотеку',
  ...
  'AlreadyTaken': {
    languageEn:
        "It looks like that nickname that you've chosen is already taken",
    languageRu: 'Похоже, что выбранный тобой никнейм уже занят',
    languageUa: 'Схоже, що обраний тобою нікнейм вже зайнят',
    languagePl:
  ...
  '30DaysNotPassedNickname': {
    ...
    languageRu:
        'Воу, с момента прошлого изменения никнейма ещё не прошло тридцати дней',
    languageUa:
        'Воу, з моменту минулої зміни нікнейма ще не пройшло тридцяти днів',
    languagePl:
  ...
  '30DaysNotPassedAvatar': {
    ...
    languageRu:
        'Воу, с момента прошлого изменения аватарки ещё не прошло тридцати дней',
    languageUa:
        'Воу, з моменту минулої зміни аватарки ще не пройшло тридцяти днів',
    languagePl:
  ...
  '1DayNotPassedStatus': {
    languageEn:
        "Oops, twenty four hours have to pass since the last status change",
    languageRu:
        'Воу, с момента прошлого изменения статуса ещё не прошло двадцати четырёх часов',
    languageUa:
        'Воу, з моменту минулої зміни статусу ще не пройшло двадцяти чотирьох годин',
    languagePl:
  ...
  'UpdatingTheApp': {
    ...
    languageRu: 'Обновляем приложение',
  ...
  'IssuesDescription': {
    languageEn:
        "The modification didn't launch, the game crashed,\nor you've encountered some kind of problem?\nThen click here!",
    languageRu:
        'Модификация не запустилась, произошел вылет\nигры или же у тебя появилась какая-топроблема?\nТогда загляни сюда!',
    languageUa:
        "Модифікація не запустилася, стався виліт\nгри або ж у тебе з'явилася якась проблема?\nТоді заглянь сюди!",
    languagePl:
  ...
  'NoInternetForConfigurations': {
    languageEn:
        "Unfortunately, you won't be able to use the ConfigurationsHUB in offline mode. Wait until the application reconnects to the server and try again!",
    languageRu:
        'К сожалению, ты не сможешь использовать центр конфигураций в автономном режиме. Дождись, пока приложение восстановит соединение с сервером и попробуй ещё раз!',
    languageUa:
        "На жаль, ти не зможеш використовувати центр конфігурацій в автономному режимі. Дочекайся, поки додаток відновить з'єднання з сервером і спробуй ще раз!",
    languagePl:
  ...
  'ConfigAlreadyDeleted': {
    languageEn:
        "While you were looking for a configuration, this file has already been deleted",
    languageRu: 'Пока ты искал себе конфигурацию, этот файл уже удалили',
    languageUa: "Поки ти шукав собі конфігурацію, цей файл вже видалили",
    languagePl:
  ...
  'ConfigurationWasSuccessfullyDeleted': {
    languageEn:
        "Your configuration has been successfully deleted from the application's server!",
    languageRu: 'Твоя конфигурация была успешно удалена с сервера приложения!',
    languageUa: "Твоя конфігурація була успішно видалена з сервера програми!",
    languagePl:
  ...
  'SearchByConfigs': {
    ...
    languageRu: 'Поиск по конфигурациям',
  ...
  'SuccessfulConfigurationUpload': {
    languageEn:
        "Your configuration has been successfully uploaded to the application's server!",
    languageRu: 'Твоя конфигурация успешно загружена на сервер приложения!',
    languageUa: "Твоя конфігурація успішно завантажена на сервер програми!",
    languagePl:
  ...
  'SuccessfulConfigurationEditing': {
    languageEn:
        "Your configuration has been successfully resaved on the application's server!",
    languageRu:
        'Твоя конфигурация успешно пересохранена на сервере приложения!',
    languageUa: "Твоя конфігурація успішно пересохранена на сервері програми!",
    languagePl:
  ...
  'ConfigurationAlreadyUploaded': {
    languageEn:
        "It looks like that exactly the same configuration has already been uploaded to the server by another user!",
    languageRu:
        'Похоже, что точно такая-же конфигурация уже загружена на сервер другим пользователем!',
    languageUa:
        "Схоже, що точно така-ж конфігурація вже завантажена на сервер іншим користувачем!",
    languagePl:
  ...
  'ConfigurationAlreadyDeleted': {
    languageEn:
        "Failed to edit this configuration, it looks like it has already been deleted!",
    languageRu:
        'Не удалось отредактировать данную конфигурацию, похоже, что она уже удалена!',
    languageUa:
        "Не вдалося відредагувати цю конфігурацію, схоже, що вона вже видалена!",
    languagePl:
  ...
  'FailedToFindConfig': {
    ...
    languageRu: 'Не удалось найти конфигурацию с таким названием',
  ...
  'NoComplaintsInOfflineMode': {
    ...
    languageRu: 'Отправка жалоб недоступна в автономном режиме!',
    languageUa: "Надсилання скарг недоступне в автономному режимі!",
  ...
  'PleaseWaitBeforeComplaint': {
    languageEn:
        "Well... Thank you for trying to help our project so hard, but such an often complaints sending look like spam. For this reason, we have restricted your access to this feature for half an hour. Sorry if we are wrong...",
    languageRu:
        'Спасибо конечно, что так старательно пытаешься помочь нашему проекту, но столь частая отправка жалоб похожа на спам. По этой причине мы ограничили твой доступ к этой функции на полчаса. Такие вот дела...',
    languageUa:
        "Спасибі звичайно, що так старанно намагаєшся допомогти нашому проекту, але настільки часта відправка скарг схожа на спам. З цієї причини ми обмежили твій доступ до цієї функції на півгодини. Такі ось справи...",
    languagePl:
  ...
  'ConfigComplaintIsHandled': {
    languageEn:
        "Your complaint about the configuration or LUA has been processed! Thank you for participating in application's development",
    languageRu:
        'Твоя жалоба на конфигурацию или же ЛУА обработана! Спасибо, что участвуешь в развитии нашего приложения',
    languageUa:
        "Твоя скарга на конфігурацію або ж ЛУА оброблена! Спасибі, що береш участь у розвитку ExLoader",
    languagePl:
        'Twoja skarga dotycząca konfiguracji lub LUA została rozpatrzona! Dziękujemy za udział w rozwoju ExLoadera',
    languageDe:
        'Ihre Beschwerde über die Konfiguration oder LUA wurde bearbeitet! Vielen Dank für Ihre Teilnahme an der Entwicklung von ExLoader',
    languageIt:
        'Il tuo reclamo sulla configurazione o LUA è stato elaborato! Grazie per la tua partecipazione allo sviluppo di ExLoader',
    languageTr:
        'Yapılandırması veya LUA hakkındaki şikayetiniz işleme alındı! Uygulamanın geliştirilmesine katıldığınız için teşekkür ederiz',
    languageEs:
  ...
  'ReviewComplaintIsHandled': {
    languageEn:
        "Your complaint about «{user}'s» review has been processed! Thank you for participating in application's development",
    languageRu:
        'Твоя жалоба на комментарий пользователя «{user}» обработана! Спасибо, что участвуешь в развитии нашего приложения',
    languageUa:
        "Твоя скарга на комментар користувача «{user}» оброблена! Спасибі, що береш участь у розвитку ExLoader",
    languagePl:
        'Twoja skarga dotycząca recenzji użytkownika «{user}» została rozpatrzona! Dziękujemy za udział w rozwoju ExLoadera',
    languageDe:
        'Ihre Beschwerde über den Kommentar von Benutzer «{user}» wurde bearbeitet! Vielen Dank für Ihre Teilnahme an der Entwicklung von ExLoader',
    languageIt:
        'Il tuo reclamo relativo al commento dell`utente «{user}» è stato elaborato! Grazie per la tua partecipazione allo sviluppo di ExLoader',
    languageTr:
        "«{user}'s» incelemesi hakkındaki şikayetiniz, işleme alındı! Uygulamanın geliştirilmesine katıldığınız için teşekkür ederiz",
    languageEs:
  ...
  'ReviewAnswer': {
    ...
    languageRu:
        'Пользователь «{user}» ответил на твой комментарий в ветке «{review}»',
    languageUa:
        "Користувач «{user}» відповів на твій комментар у нитці «{review}»",
    languagePl:
  ...
  'BranchIsDeleted': {
    ...
    languageRu: 'К сожалению, эта ветка комментариев уже удалена',
  ...
  'CreateNickname': {
    ...
    languageRu: 'Придумай себе никнейм:',
  ...
  'RulesBasic': {
    languageEn:
        "So that reviews and other social activity places of our application do not become a place where even the most ardent freaks don't want to open, try following the rules described below!",
    languageRu:
        'Чтобы комментарии и другие места с социальной активностью в нашем приложении не стали тем местом, куда не захотят заходить даже самые ярые фрики, старайся соблюдать правила, описанные ниже!',
    languageUa:
        "Щоб коментарі та інші місця з соціальною активністю в нашому додатку не стали тим місцем, куди не захочуть заходити навіть найзапекліші фріки, старайся дотримуватися правил, описані нижче!",
    languagePl:
  ...
  'WhatShouldNotBeDone': {
    ...
    languageRu: 'ЧЕГО ЛУЧШЕ НЕ ДЕЛАТЬ?',
  ...
  "RulesAreRules": {
    languageUa: """
1. Ображати, проявляти агресію, погрожувати або ж провокувати інших користувачів програми. (Правило "він перший почав" тут не працює).

2. Намагатися спровокувати інших користувачів на порушення правил ExLoader.

3. Рекламувати що-небудь, розміщувати посилання на файли, непопулярні канал або соціальні мережі.

4. Дискримінувати користувачів програми або ж окремі групи на основі їх національності, віку, віри, і т.п.

5. Опублікувати 18+ або шокуючі матеріали в будь-якому вигляді (GIF-файли, картинки, відео, текстові описи, посилання, тощо, сюди входять еротичні, насильницькі, неприємні та інші подібні сціни).

6. Використовувати матеріали, описані в пункті "5" в аватарці, нікнеймі, статусі або ж посиланням на соціальну мережу.

7. Спамити, флудити, відправляти велику кількість безглуздих повідомлень.

8. Зловживати скаргами на інших користувачів.

9. Намагатися обійти бан, шляхом створення декількох акаунтів.

10. Намагатися ввести інших користувачів в оману, шляхом видавання себе за модерацію або ж адміністрацію проекту.

11. Деанонімізувати інших користувачів без їх згоди, поширювати особисті контакти людей без їх попиту.

12. Засмічувати коментарі або ж конфігурації злісними суперечками.

13. Вживати ненормативну лексику без особливих приводів, практично в кожному відгуку або ж в своєму нікнеймі.

14. Писати відгуки або ж опису завантажуваних конфігурацій не по темі.

15. Накручувати позитивні або ж негативні оцінки до відгуків, конфігурацій та інших подібних місць.

16. Намагатися поширити віруси, шкідливі для пристрою або ж непотрібні файли тим чи іншим шляхом.

17. Намагатися обійти правила, знаходячи лазівки. Якщо ти так зробиш, ми просто оновимо правила і все-одно покараємо тебе за їх порушення!
""",
    languageRu: """
1. Оскорблять, проявлять агрессию, угрожать или же провоцировать других пользователей приложения. (Правило "Он первый начал" тут не работает).

2. Пытаться спровоцировать других пользователей на нарушение правил ExLoader.

3. Рекламировать что-либо, размещать ссылки на файлы или же непопулярные каналы или же социальные сети.

4. Дискриминировать пользователей приложения или же отдельные группы на основе их национальности, возраста, веры, и т.п.

5. Публиковать 18+ или же шокирующие материалы в любом виде (гифки, картинки, видео, текстовые описания, ссылки, и т.п., сюда входят эротические, насильственные, неприятные и другие похожие сцены).

6. Использовать материалы, описанные в пункте "5", в аватарке, никнейме, статусе или же ссылке на социальную сеть.

7. Спамить, флудить, отправлять большое количество бессмысленных сообщений.

8. Злоупотреблять жалобами на других пользователей.

9. Пытаться обойти бан, путём создания нескольких аккаунтов.

10. Пытаться ввести других пользователей в заблуждение, путём выдавания себя за модерацию или же администрацию проекта.

11. Деанонимизировать других пользователей без их согласия, распространять личные контакты людей без их спроса.

12. Засорять комментарии или же конфигурации злостными спорами.

13. Употреблять ненормативную лексику без особых поводов, практически в каждом сообщении или же в своём никнейме.

14. Писать отзывы или же описания загружаемых конфигураций не по теме.

15. Накручивать положительные или же отрицательные оценки к отзывам, конфигурациям и другим подобным местам.

16. Пытаться распространить вирусы, вредные для устройства или же бесполезные файлы тем или иным путём.

17. Пытаться обойти правила, находя лазейки. Если ты так сделаешь, мы просто обновим правила и всё-равно накажем тебя за их нарушение!
""",
    languageEn: """
1. Offend, try to show an aggression, threaten or provoke other users of the application. (Rule "He started it first" doesn't work here).

2. Try to provoke other users to violate application's rules.

3. Advertise anything, post links that lead to files, unpopular channels or social networks.

4. Discriminate against ExLoader users or individual groups based on their nationality, age, faith, etc.

5. Publish 18+ or shocking materials in any form (gifs, pictures, videos, text descriptions, links, etc., this includes erotic, violent, unpleasant and other similar scenes).

6. Use the materials described in rule "5" for the avatar, nickname, status or social network link.

7. Spam, flood, send a large number of meaningless messages.

8. Abuse complaints about other users.

9. Try to bypass the ban by creating multiple accounts.

10. Try to mislead other users by posing as moderation or the administration of the project.

11. Deanonymize other users without their consent, distribute personal contacts of people without their demand.

12. Litter reviews or configurations with aggressive disputes.

13. Use profanity for no particular reason, in almost every review or configuration description or in your nickname.

14. Write meaningless reviews or descriptions of uploaded configurations.

15. Wind up positive or negative rating votes for reviews, configs and other similar places.

16. Try to spread viruses, harmful or useless files in one way or another.

17. Try to circumvent the rules by finding loopholes. If you do that, we'll just update the rules and punish you for breaking them anyway!
""",
    languagePl: """
1. Obrażanie, próba okazywania agresi, grożenie lub prowokowanie innych użytkowników aplikacji. (Reguła «On zaczął to pierwszy» nie działa tutaj).

2. Staranie się prowokować innych użytkowników do łamania zasad aplikacji.

3. Reklamowanie czegokolwiem, publikowanie linków prowadzące do plików, niepopularnych kanałów lub sieci społecznościowych.

4. Dyskryminowanie użytkowników ExLoadera lub poszczególnych grup na podstawie ich narodowości, wieku, wyznania itp.

5. Publikowanie materiałów 18+ lub szokujących w dowolnej formie (gify, zdjęcia, filmy, opisy tekstowe, linki itp., w tym sceny erotyczne, brutalne, nieprzyjemne i inne podobne).

6. Używanie materiałów opisanych w zasadzie «5» jako awatara, pseudonimu, statusu lub linku do sieci społecznościowej.

7. Spam, wysyłanie dużej ilości bezsensownych wiadomości.

8. Nadużywanie skarg o innych użytownikach.

9. Próba ominięcia bana, poprzez tworzenie wielu kont.

10. Próba wprowadzenia innych użytkowników w błąd podając się za moderację lub administrację projektu.

11. Deanonimizowanie innych użytkowników bez ich zgody, rozpowszechnianie osobistych kontaktów osób bez ich zgody.

12. Zaśmiecanie komentarzy lub konfiguracji złośliwymi kłótniami.

13. Używanie wulgaryzmów bez konkretnego powodu, w prawie każdej recenzji lub opisie konfiguracji lub w swoim pseudonimie.

14. Pisanie bezsensownych recenzji lub opisów przesłanych konfiguracji.

15. Rozkręcanie pozytywnych lub negatywnych oceny recenzji, konfiguracji i innych podobnych miejsc.

16. Próba rozprzestrzeniania wirusów szkodliwych dla urządzenia lub bezużytecznych plików w taki czy inny sposób.

17. Próba obejścia zasady, znajdując luki. Jeśli to zrobisz, po prostu zaktualizujemy zasady i i tak ukaramy cię za ich złamanie!
""",
    languageDe: """
1. Beleidigen, aggressiv sein, andere Nutzer der App bedrohen oder provozieren. (Die Regel "Er hat zuerst angefangen" funktioniert hier nicht.)

2. Versuchen, andere Benutzer zu provozieren, gegen die ExLoader-Regeln zu verstoßen.

3. Werbung für etwas, Links zu Dateien oder unpopuläre Kanäle oder soziale Netzwerke.

4. Benutzer der App oder einzelne Gruppen aufgrund ihrer Nationalität, ihres Alters, ihres Glaubens usw. diskriminieren.

5. 18+ oder schockierendes Material in beliebiger Form veröffentlichen (GIFs, Bilder, Videos, Textbeschreibungen, Links usw., dazu gehören erotische, gewalttätige, unangenehme und ähnliche Szenen).

6. Verwenden Sie die unter "5" beschriebenen Materialien in Ihrem Avatar, Ihrem Nickname, Ihrem Status oder einem Link zu einem sozialen Netzwerk.

7. Spam, Flut, senden Sie eine große Anzahl bedeutungsloser Nachrichten.

8. Missbrauchen von Beschwerden gegen andere Benutzer.

9. Versuchen Sie, das Verbot zu umgehen, indem Sie mehrere Konten erstellen.

10. Versuchen, andere Benutzer in die Irre zu führen, indem Sie sich als Moderation oder Projektverwaltung ausgeben.

11. Andere Benutzer ohne ihre Zustimmung deanonymisieren, persönliche Kontakte von Personen ohne ihre Nachfrage verteilen.

12. Kommentare oder Konfigurationen mit bösartigen Streitigkeiten zu verstopfen.

13. Verwenden Sie Obszönitäten ohne besonderen Anlass, in fast jeder Nachricht oder in Ihrem Spitznamen.

14. Schreiben Sie Bewertungen oder Beschreibungen von herunterladbaren Konfigurationen, die nicht zum Thema gehören.

15. Positive oder negative Bewertungen zu Bewertungen, Konfigurationen und ähnlichen Orten aufschrauben.

16. Versuchen, Viren zu verbreiten, die das Gerät schädigen oder auf andere Weise nutzlose Dateien verwenden.
...
""",
  ...
  'ViolateAnd': {
    ...
    languageRu: 'ЧТО БУДЕТ, ЕСЛИ Я НАРУШУ ПРАВИЛА?',
  ...
  'ViolateDescription': {
    languageEn:
        "Nothing! Just joking..., first your reputation level will be dropped by other ExLoader users, and then you will be banned, what will lead to a full limitation of all application's social activity. So be nice, talk with others the way you would like others to talk with you, be friendly, and everything will be fine!",
    languageRu:
        'Ничего! Шутка, сперва твой уровень репутации будет занижен другими пользователями ExLoader, а затем ты и вовсе получишь бан, который ограничит всю социальную активность в приложении. Так что будь паинькой, общайся с другими так, как хотел бы, чтобы другие общались с тобой, будь адекватным и дружелюбным, и всё будет хорошо!',
    languageUa:
        "Нічого! Жарт, спершу твій рівень репутації буде занижен іншими користувачами ExLoader, а потім ти і зовсім отримаєш бан, який обмежить всю соціальну активність в програмі. Так що будь доброзичливим, спілкуйся з іншими так, як хотів би, щоб інші спілкувалися з тобою, і все буде добре!",
    languagePl:
  ...
  'NoNotificationsInOffline': {
    languageEn:
        "Unfortunately, you can not open notifications screen in offline mode",
    languageRu:
        'К сожалению, просмотр уведомлений недоступен в автономном режиме',
    languageUa: "На жаль, перегляд сповіщень недоступний в автономному режимі",
    languagePl:
  ...
  'NoNotifications': {
    ...
    languageRu: 'А уведомлений то нет!',
  ...
  // TODD:!
  'Newbies': {
    languageEn: 'Newbies and returnees in the library: ',
    languageRu: 'Новинки и возвращённые модификации: ',
    languageUa: 'Новинки та повернуті модифікації: ',
    languagePl: 'Nowe modyfikacje i przywrócone: ',
    languageDe: "Neue und zurückgegebene mods: ",
    languageIt: 'Novità e modifiche restituite: ',
  ...
  'GotUpdated': {
    ...
    languageRu: "Модификации, получившие обновление: ",
    languageUa: "Модифікації, які отримали оновлення: ",
    languagePl: "Modyfikacje, które otrzymały aktualizacje: ",
    languageDe: "Modifikationen, die erhielten Updates: ",
    languageIt: 'Modifiche che sono state aggiornate: ',
  ...
  'WereDeleted': {
    ...
    languageRu: "Удалённые модификации: ",
    languageUa: "Видалені модифікації: ",
    languagePl: "Usunięte modyfikacje: ",
    languageDe: "Gelöschte mods: ",
    languageIt: 'Modifiche eliminate: ',
  ...
  'Microsoft': {
    ...
    languageRu: 'Компоненты Microsoft',
  ...
  'MicrosoftNotFound': {
    languageEn:
        'Microsoft Visual C++ Redistributable packages are not installed!',
    languageRu: 'Распространяемые пакеты Microsoft VC++ не установлены!',
  ...
  'MicrosoftFound': {
    ...
    languageRu: 'Распространяемые пакеты Microsoft VC++ установлены',
  ...
  'SystemVersionGood': {
    ...
    languageRu:
        'Твоя система работает на самой актуальной версии используемой Windows',
    languageUa:
        'Твоя система працює на найактуальнішій версії використовуваної Windows',
    languagePl:
  ...
  'SystemVersionBad': {
    languageEn:
        "It seams that your Windows version can be updated to a newer one!",
    languageRu:
        'Похоже, что ты можешь обновить свою версию Windows до более актуальной версии!',
    languageUa:
        'Схоже, що ти можеш оновити свою версію Windows до більш актуальної версії!',
    languagePl:
  ...
  'SystemVersionWhy': {
    languageEn:
        "Try to regularly check your operating system for new updates, and also use the latest Windows version from the Microsoft website. You can check updates in Windows update center.",
    languageRu:
        'Старайся регулярно проверять свою операционную систему на наличие новых обновлений, а также используй самую последнюю версию Windows с сайта Microsoft. Ты можешь проверять наличие обновлений в центре обновления Windows.',
    languageUa:
        'Намагайся регулярно перевіряти свою операційну систему на наявність нових оновлень, а також використовуй саму останню версію Windows з сайту Microsoft. Ти можеш перевірити наявність оновлень у центрі оновлення Windows.',
    languagePl:
  ...
  'AntivirusSoftware': {
    ...
    languageRu: 'Конфликтующие приложения',
  ...
  'AntivirusSoftwareNotFound': {
    ...
    languageRu: 'Программное обеспечение, конфликтующее с ExLoader, не найдено',
    languageUa:
        'Програмне забезпечення, яке конфліктує з ExLoader, не знайдено',
    languagePl:
  ...
  'AntivirusSoftwareFound': {
    languageEn:
        'There are programs installed on your device that interfere with the correct operation of modifications!',
    languageRu:
        'На твоём устройстве найдены программы, мешающие корректной работе модификаций!',
    languageUa:
        'На твоєму пристрої знайдені програми, заважащі коректній роботі модифікацій!',
    languagePl:
  ...
  'AntivirusWhy': {
    languageEn:
        'Most antivirus programs consider modifications suspicious and block their correct operation. Please note that often the usual disabling of the antivirus does not help to solve the problem!',
    languageRu:
        'Большинство антивирусных программ считает модификации подозрительным ПО и блокируют их корректную работу. Обрати внимание, что зачастую обычное отключение антивируса не помогает решить проблему!',
    languageUa:
        'Більшість антивірусних програм вважає модифікації підозрілими і блокують їх коректну роботу. Зверни увагу, що найчастіше звичайне відключення антивіруса не допомагає вирішити проблему!',
    languagePl:
  ...
  'ListOfFound': {
    ...
    languageRu: 'Список обнаруженного программного обеспечения',
  ...
  'Recommended': {
    ...
    languageRu: 'Недостающие параметры запуска',
  ...
  'NotRecommended': {
    ...
    languageRu: 'Лишние параметры запуска',
  ...
  'DisableFullscreen': {
    ...
    languageRu:
        'Отключи полноэкранный режим для корректной работы модификации!',
    languageUa: 'Вимкни повноекранний режим для коректної роботи модифікації!',
    languagePl:
  ...
  'LaunchOptions': {
    ...
    languageRu: 'Параметры запуска и настройки',
  ...
  'LaunchOptionsGood': {
    languageEn:
        'Your game launch options and settings match the recommended ones',
    languageRu:
        'Твои параметры запуска и настройки игры соответствуют рекомендованным',
    languageUa:
        'Твої параметри запуску і налаштування гри відповідають рекомендованим',
    languagePl:
  ...
  'GoodParams': {
    languageEn:
        "Launch options and settings are good, you don't have to anything.",
    languageRu: 'Параметры запуска в норме, никаких действий не требуется.',
    languageUa: 'Параметри запуску в нормі, ніяких дій не потрібно.',
    languagePl:
  ...
  'OwnLoader': {
    ...
    languageRu: 'Дополнительный лаунчер',
  ...
  'OwnLoaderDescription': {
    ...
    languageRu:
        'Эта модификация использует свой собственный лоадер для инъекции!',
    languageUa: "Ця модифікація використовує свій власний лоадер для ін'єкції!",
    languagePl:
  ...
  'OwnLoaderTooltip': {
    languageEn:
        "Any problems associated with the launch process of this modification do not apply to ExLoader, since it uses its own launcher during the injection process!",
    languageRu:
        'Любые проблемы, связанные с запуском данной модификации не относятся к ExLoader, так как она использует свой собственный лаунчер в процессе инъекции!',
    languageUa:
        "Будь-які проблеми, пов'язані з запуском даної модифікації не відносяться до ExLoader, так як вона використовує свій власний лаунчер в процесі ін'єкції!",
    languagePl:
  ...
  'ModificationVersionBad': {
    languageEn:
        "Modification's build date differs from the latest game update date!",
    languageRu: 'Дата сборки модификации отличается от даты обновления игры!',
    languageUa:
        'Дата складання модифікації відрізняється від дати оновлення гри!',
    languagePl:
  ...
  'ModificationVersionGood': {
    languageEn:
        'The modification is up to date and supports the latest version of the game',
    languageRu: 'Модификация актуальна и поддерживает последнюю версию игры',
    languageUa: 'Модифікація актуальна і підтримує останню версію гри',
  ...
  'UpdateModification': {
    languageEn:
        'Many modifications or part of their functionality stop working after game updates. If the reason of game crash is this problem, just wait until the developer updates his product, there are no other solutions. Remember that modifications are being updated by their creators, not by the ExLoader team!',
    languageRu:
        'Многие модификации или часть их функционала перестают работать после выхода обновлений игры. Если причиной вылета является именно это проблема, просто ожидай, пока разработчик обновит свой продукт, других решений нет. Помни, что обновлениями модификаций занимаются их создатели, а не команда ExLoader!',
    languageUa:
        "Багато модифікації або частина їх функціоналу перестають працювати після виходу оновлень гри. Якщо причиною вильоту є саме це проблема, просто чекай, поки розробник оновить свій продукт, інших рішень немає! Пам'ятай, що оновленнями модифікацій займаються їх творці, а не команда ExLoader!",
    languagePl:
  ...
  'ConfigsAndOptions': {
    ...
    languageRu: 'Конфигурации и опции',
  ...
  'ConfigsAndOptionsTip': {
    languageEn:
        'Check the configs you use or configure the modifications manually!',
    languageRu:
        'Проверяй используемые конфиги или настраивай модификации вручную!',
    languageUa:
        'Перевіряй використовувані конфіги або налаштовуй модифікації вручну!',
    languagePl:
  ...
  'CrashForConfig': {
    languageEn:
        "If you encounter game crash after loading a config or after enabling some function - that's the reason of the crash. Try configuring the modification by yourself or download only the most recently updated configs.",
    languageRu:
        'Если модификация вылетает при загрузке конфига или при включении какой-либо функции - вот тебе и причина вылета. Старайся настраивать модификации самостоятельно или скачивай только актуальные конфиги.',
    languageUa:
        'Якщо модифікація вилітає при завантаженні конфіга або при включенні будь-якої функції - ось тобі і причина вильоту. Намагайся налаштовувати модифікації самостійно або завантажуй тільки актуальні конфігурації.',
    languagePl:
  ...
  'ModificationsSource': {
    ...
    languageRu: 'Источник модификации',
  ...
  'ModificationsSourceTip': {
    ...
    languageRu: 'Выбранная модификация не из библиотеки ExLoader!',
    languageUa: 'Обрана модифікація не з бібліотеки ExLoader!',
  ...
  'NotFromExLoader': {
    languageEn:
        'Modifications that you add by yourself may be outdated or contain virus software instead of the functionality of the modification itself. When you play with manually added modifications, pay attention to the source of their publication, as well as the date of their last update!',
    languageRu:
        'Модификации, которые ты добавляешь сам, могут быть неактуальными или содержать в себе вирусное ПО вместо функционала самой модификации. При игре с внешними модификациями обращай внимание на источник их публикации, а также на дату их последнего обновления!',
    languageUa:
        'Модифікації, які ти додаєш самостійно, можуть бути неактуальними або містити в собі вірусне ПЗ замість функціоналу самої модифікації. При грі з зовнішніми модифікаціями звертай увагу на джерело їх публікації, а також на дату їх останнього оновлення!',
    languagePl:
  ...
  'InjectionMethodDescription': {
    languageEn:
        "Current launch method may be incompatible with modification's recommended one!",
    languageRu:
        'Текущий метод запуска может быть несовместим с рекомендованным методом запуска модификации!',
    languageUa:
        "Поточний метод запуску може бути несумісний з рекомендованим методом запуску модифікації!",
    languagePl:
  ...
  'InjectionMethodTip': {
    languageEn:
        "Not all modifications support the same injection method. Try opening the ExLoader settings and changing the preferred modifications launch method. We do not give any guarantees that this will help 100%, but it's still worth a try.",
    languageRu:
        'Не все модификации поддерживают одинаковый способ инъекции. Попробуй зайти в настройки ExLoader и изменить предпочитаемый способ запуска модификаций. Мы не даём никаких гарантий, что это 100% поможет, но попробовать всё-таки стоит.',
    languageUa:
        "Не всі модифікації підтримують однаковий спосіб ін'єкції. Спробуй зайти в налаштування ExLoader і змінити бажаний спосіб запуску модифікацій. Ми не даємо ніяких гарантій, що це 100% допоможе, але спробувати все-таки варто.",
    languagePl:
  ...
  'InjectionMethodTipSecond': {
    languageEn:
        'Not all modifications support the same injection method, however, you have already tried all available in ExLoader ways, and this means that most likely, the problem of the game crash lies in something else.',
    languageRu:
        'Не все модификации поддерживают одинаковый способ инъекции, однако, ты уже испробовал все доступные в ExLoader методы запуска, а это значит, что скорее всего, проблема вылета кроется в чём-то другом.',
    languageUa:
        "Не всі модифікації підтримують однаковий спосіб ін'єкції, однак, ти вже випробував всі доступні в ExLoader методи запуску, а це означає, що швидше за все, проблема вильоту криється в чомусь іншому.",
    languagePl:
  ...
  'ServersTypeDescription': {
    languageEn:
        "Most of modifications are optimized only for playing on official game servers!",
    languageRu:
        'Зачастую модификаций оптимизированы лишь под игру на официальных серверах игры!',
    languageUa:
        "Найчастіше модифікацій оптимізовані лише під гру на офіційних серверах гри!",
    languagePl:
  ...
  'ServersTypeTooltip': {
    languageEn:
        "Custom anti-cheat community servers can block part of the modification's functionality and thereby cause game crashes while loading on the map.",
    languageRu:
        'Кастомные античиты серверов сообщества могут блокировать часть функционала модификации и тем самым вызывать вылеты игры при загрузке на карту.',
    languageUa:
        "Кастомні античитові спільноти можуть блокувати частину функціоналу модифікації і тим самим викликати вильоти гри при завантаженні на карту.",
    languagePl:
  ...
  'SystemResult': {
    ...
    languageRu: 'Популярные проблемы и их решения',
  ...
  'OverlayStatus': {
    ...
    languageRu:
        'Некоторые приложения могут повлиять на систему рендера модификации!',
    languageUa:
        'Деякі програми можуть вплинути на систему візуалізації модифікації',
    languagePl:
  ...
  'OverlayDescription': {
    languageEn:
        'Some applications like OBS, Bandicam, Fraps, Action, Nvidia ShadowPlay, FPS monitor, MSI Afterburner and other similar overlays may affect the fact that the menu of the launched modification will not be displayed in the game. If you encounter such problem, try disabling them before launching the modification!',
    languageRu:
        'Некоторые программы по типу OBS, Bandicam, Fraps, Action, Nvidia ShadowPlay, FPS monitor, MSI Afterburner и другие подобные оверлеи могут повлиять на то, что меню запущенной модификации не отобразится в игре. Если ты столкнёшься с подобной проблемой, попробуй отключить их перед запуском модификации!',
    languageUa:
        'Деякі програми по типу OBS, Bandicam, Fraps, Action, Nvidia ShadowPlay, FPS monitor, MSI Afterburner і інші подібні оверлеї можуть вплинути на те, що меню запущеної модифікації не відобразитися в грі. Якщо ти зіткнешся з подібною проблемою, спробуй відключити їх перед запуском модифікації!',
    languagePl:
  ...
  'FPS': {
    ...
    languageRu: 'Производительность игры',
  ...
  'FPSStatus': {
    ...
    languageRu:
        'Не все модификации должным образом оптимизированы под слабые устройства!',
    languageUa:
        'Не всі модифікації належним чином оптимізовані під слабкі пристрої!',
    languagePl:
  ...
  'FPSDescription': {
    languageEn:
        "FPS drop while playing the game with some specific modification is quite a common phenomenon. Alas, it is impossible to fix it manually. The problem is that many developers don't even try to write good and optimized code for their projects. The only solution is to use other modifications.",
    languageRu:
        'Падение фпс при игре с какой-то конкретной модификацией довольно-таки распространённое явление. Увы, это невозможно исправить вручную. Проблема в том, что многие разработчики даже не пытаются писать хороший и оптимизированный код к своим проектам. Единственное решение - использование других модификаций.',
    languageUa:
        'Падіння фпс при грі з якоюсь конкретною модифікацією досить-таки поширене явище. На жаль, це неможливо виправити вручну. Проблема в тому, що багато розробників навіть не намагаються писати хороший і оптимізований код до своїх проектів. Єдине рішення-використання інших модифікацій.',
    languagePl:
  ...
  'WhatCouldHappen': {
    ...
    languageRu: 'Что могло на это повлиять?',
  ...
  'ActionNeeded': {
    ...
    languageRu: 'Необходимо твоё действие...',
  ...
  'NoProfileInOffline': {
    ...
    languageRu: 'К сожалению, открытие профиля недоступно в автономном режиме',
    languageUa: 'На жаль, відкриття профілю недоступне в автономному режимі',
    languagePl: 'Niestety otwarcie profilu nie jest dostępne w trybie offline',
    languageDe:
  ...
  'ProfileLinkCopied': {
    ...
    languageRu: 'Юзернейм профиля скопирован в твой буфер обмена!',
    languageUa: 'Юзернейм профілю скопійован в твій буфер обміну!',
  ...
  'StatsIsEmpty': {
    languageEn:
        "It looks like that this user hasn't launched any modification with ExLoader yet",
    languageRu:
        'Похоже, что этот пользователь ещё не запускал модификации с помощью ExLoader',
    languageUa:
        'Здається, цей користувач ще не запускав модифікації за допомогою ExLoader',
    languagePl:
  ...
  'KeepUp': {
    languageEn:
        'Keep it up, keep playing with various modifications from the ExLoader library and soon your personal statistics for each of them will appear in this section!',
    languageRu:
        'Так держать, продолжай играй с различными модификациями из библиотеки ExLoader, и вскоре твоя персональная статистика к каждой из них появится в этом разделе!',
    languageUa:
        "Так тримати, продовжуй грати з різними модифікаціями з бібліотеки ExLoader, і незабаром твоя персональна статистика до кожної з них з'явиться в цьому розділі!",
    languagePl:
  ...
  'InfoHidden': {
    languageEn:
        'The rest of the profile information is hidden by the privacy settings',
    languageRu: 'Остальная информация о профиле скрыта настройками приватности',
    languageUa: 'Інша інформація про профіль прихована настройками приватності',
    languagePl:
  ...
  'ForgeFirst': {
    languageEn:
        '– Click here to open official Forge website, choose your game version in the left-side Column and press «Installer» in «Download Recommended» block.',
    languageRu:
        '– Кликни сюда, дабы открыть официальный сайт Forge, выбери необходимую версию игры в таблице слева и нажми «Installer» в блоке «Download Recommended».',
    languageUa:
        '– Натисни сюди, щоб відкрити офіційний сайт Forge, вибери необхідну версію гри в таблиці зліва і натисни «Installer» в блоці «Download Recommended».',
    languagePl:
  ...
  'FabricFirst': {
    languageEn:
        '– Click here to open official Fabric website and press «Download for Windows» button.',
    languageRu:
        '– Кликни сюда, дабы открыть официальный сайт Fabric и нажми кнопку «Download for Windows».',
    languageUa:
        '– Натисни сюди, щоб відкрити офіційний сайт Fabric і натисни кнопку «Download for Windows».',
    languagePl:
  ...
  'ForgeSecond': {
    languageEn:
        '– Open the downloaded installer, make sure that the game path is specified correctly, click «Ok», and wait for the Forge installation to complete.',
    languageRu:
        '– Открой скачанный установщик, убедись, что путь к игре указан верно, нажми «Ok», и дождись завершения установки Forge.',
    languageUa:
        '– Відкрий скачаний установник, переконайся, що шлях до гри вказано вірно, натисни «Ok», і дочекайся завершення установки Forge.',
    languagePl:
  ...
  'FabricSecond': {
    languageEn:
        '– Open the downloaded installer, select your version of the game, make sure that the game path is specified correctly, click «Install», and wait for the Fabric installation to complete.',
    languageRu:
        '– Открой скачанный установщик, выбери необходимую версию игры, убедись, что путь к игре указан верно, нажми «Install», и дождись завершения установки Fabric.',
    languageUa:
        '– Відкрий скачаний установник, вибери необхідну версію гри, переконайся, що шлях до гри вказано вірно, натисни «Install», і дочекайся завершення установки Fabric.',
    languagePl:
  ...
  'FabricThird': {
    languageEn:
        '– Open the Fabric-API website by clicking on this text, find your version of the game in the list below, press the «Download file» button and move the downloaded file to the «mods» directory in the game folder. If there is no such folder, then create it by yourself!',
    languageRu:
        '– Открой сайт Fabric-API по нажатию на этот текст, найди свою версию игры в списке ниже, кликни по кнопке «Download file» и перемести скачанный файл в папку «mods» в папке с игрой. Если такой папки нет - создай её сам!',
    languageUa:
        '– Відкрий сайт Fabric-API після натискання на цей текст, знайди свою версію гри в списку нижче, кликни по кнопці «Download file» і перемести скачаний файл в папку «mods» в папці з грою. Якщо такої папки немає - створи її сам!',
    languagePl:
  ...
  'DoYouHaveThisFabricOrForge': {
    languageEn:
        'Do you have an already installed {components} for this version of the game?',
    languageRu: 'У тебя уже установлен {components} под выбранную версию игры?',
    languageUa: 'У тебе вже встановлен {components} під вибрану версію гри?',
    languagePl:
  ...
  'CheckThePath': {
    ...
    languageRu: 'Убедись, что путь к игре указан верно:',
  ...
  'ChooseGameOrModificationVersion': {
    ...
    languageRu: 'Выбери версию игры или же модификации:',
  ...
  'ChooseVersionFirst': {
    languageEn:
        'To continue, you need to choose the version of the game or modifications!',
    languageRu:
        'Для продолжения тебе необходимо выбрать версию игры или же модификации!',
    languageUa:
        'Для продовження тобі необхідно вибрати версію гри або ж модифікації!',
  ...
  'NetFrameworkIsNeeded': {
    languageEn:
        'For the correct operation of the application, you may need to install .NET Framework version 4.8! Do you want to download and install .NET Framework components right now? By the way, this step can be skipped if everything is okay with the application.',
    languageRu:
        'Для корректной работы приложения тебе может понадобиться установка .NET Framework версии 4.8! Хотешь загрузить и установить компоненты .NET Framework прямо сейчас? Кстати, ты можешь пропустить этот шаг, если с приложением всё в порядке.',
    languageUa:
        'Для коректної роботи програми тобі може знадобитися установка .NET Framework версії 4.8! Хочеш завантажити та встановити компоненти .NET Framework прямо зараз? До речі, ти можеш пропустити цей крок, якщо з додатком все в порядку.',
    languagePl:
  ...
  'FailedToInstallNetFrameworkInstaller': {
    languageEn:
        'Unfortunately, an unexpected error has occurred during the automatic installation of .NET Framework components, however, you can try to do it manually! Do you want to open the download page of .NET Framework in your browser?',
    languageRu:
        'К сожалению, в ходе автоматической установки компонентов .NET Framework произошла ошибка, однако, ты можешь попробовать сделать это вручную! Хочешь открыть страничку загрузки .NET Framework в своём браузере?',
    languageUa:
        'На жаль, в ході автоматичної установки компонентів .NET Framework сталася помилка, однак, ти можеш спробувати зробити це вручну! Хочеш відкрити сторінку завантаження .NET Framework в своєму браузері?',
    languagePl:
  ...
  'UnifiedLibrary': {
    ...
    languageRu: 'в мастер установки ExLoader',
  ...
  'WhatIsInstallerFor': {
    languageEn:
        'This installer will help you with installation of the latest ExLoader version',
    languageRu:
        'Данный ассистент поможет тебе установить самую актуальную версию ExLoader',
    languageUa:
        'Даний асистент допоможе тобі встановити найактуальнішу версію ExLoader',
    languagePl:
  ...
  'InstallationSettings': {
    ...
    languageRu: 'Настройка параметров установки',
  ...
  'ChooseInstallationPath': {
    ...
    languageRu: 'Выбери папку, в которую будет установлен ExLoader:',
    languageUa: 'Вибери папку, в яку буде встановлений ExLoader:',
  ...
  'CreateShortcut': {
    ...
    languageRu: 'Создать ярлык приложения на рабочем столе',
  ...
  'LaunchExLoader': {
    ...
    languageRu: 'Запустить ExLoader после установки',
  ...
  'AppInstalling': {
    ...
    languageRu: 'Установка приложения',
  ...
  'JustAFewMoments': {
    ...
    languageRu: 'Осталось совсем чуть-чуть, ты почти у цели!',
  ...
  'WaitForAssistant': {
    languageEn:
        'Wait for the assistant to download and install ExLoader files onto your device',
    languageRu:
        'Подожди, пока мастер установки загрузит и установит файлы ExLoader на твой компьютер',
    languageUa:
        "Зачекай, поки майстер установки завантажить і встановить файли ExLoader на твій комп'ютер",
    languagePl:
  ...
  'AppInstalled': {
    ...
    languageRu: 'ExLoader установлен',
  ...
  'EverythingIsDone': {
    ...
    languageRu: 'Всё готово, приложение уже доступно к использованию!',
  ...
  'EverythingIsDoneFinish': {
    ...
    languageRu: 'Приложение успешно установлено!',
  ...
  'ThankYouForChoosingUs': {
    ...
    languageRu: 'Спасибо, что ты выбрал нас. С уважением, SwiftSoft LLC.',
  ...
  'CloseInstallerAndOffers': {
    ...
    languageRu: 'Продолжить и закрыть установщик',
  ...
  'EverythingIsDoneShort': {
    languageEn: 'Everything is done, application is ready to use!',
    languageRu: 'Всё готово, ExLoader доступен к использованию!',
  ...
  'ErrorDuringInstallation': {
    languageEn:
        'Unfortunately, an installation error has occurred. To fix it, check your firewall and antivirus settings, and try to install our application again! Maybe you should try enabling/disabling VPN. List of possible conflicting software[might be not full]: ',
    languageRu:
        'К сожалению, в ходе установки ExLoader произошла ошибка. Для её устранения проверь настройки своего брандмауэра и антивируса, и повтори попытку установки! Возможно, тебе стоит попробовать включить или же отключить VPN. Список найденных конфликтующих приложений[может быть неполон]: ',
    languageUa:
        'На жаль, в ході установки ExLoader сталася помилка. Для її усунення перевір налаштування свого брандмауера і антивіруса, і повтори спробу установки! Можливо, тобі варто спробувати включити або ж відключити VPN. Список знайдених конфліктуючих додатків[може бути неповний]: ',
    languagePl:
  ...
  'UnifiedLibrarySlogan': {
    ...
    languageRu: 'Единая библиотека игровых модификаций',
  ...
  'UpdateFile': {
    ...
    languageRu: 'Файл обновления пока не выбран',
  ...
  'UpdateIsNeeded': {
    languageEn:
        "You have an old application client installed, upgrade to the new version using Google Play to use it!",
    languageRu:
        'У тебя установлен старый клиент приложения, обновись до новой версии с помощью Google Play для продолжения!',
    languageUa:
        'У тебе встановлен старий клієнт ExLoader, оновися до нової версії за допомогою Google Play для продовження!',
    languagePl:
  ...
  'AppIsUpdated': {
    ...
    languageRu: 'Приложение обновлено!',
  ...
  'ExloaderLauncher': {
    ...
    languageRu: 'Запуск с помощью ExLoader',
  ...
  'OriginalLauncher': {
    languageEn:
        "Launch via the official modification's launcher (for those who have problems with the first option)",
    languageRu:
        'Запуск через родной лаунчер модификации (для тех, у кого есть проблемы с первым вариантом)',
    languageUa:
        'Запуск через рідний лаунчер модифікації (для тих, у кого є проблеми з першим варіантом)',
    languagePl:
  ...
  'CrashesStats': {
    ...
    languageRu: 'Статистика по вылетам за сутки',
  ...
  'CrashesDescription': {
    ...
    languageRu: 'Данные по вылетам игр при использовании модификаций',
  ...
  'SearchByUsers': {
    ...
    languageRu: 'Поиск среди пользователей (3+ символа)',
    languageUa: 'Пошук серед користувачів (3+ символи)',
    languagePl: 'Szukaj wśród użytkowników (3+ symbole)',
    languageDe: "Suchen Sie unter Benutzern (3+ Symbole)",
    languageIt: 'Cerca tra gli utenti (3+ simboli)',
  ...
  'WaitingForInput': {
    ...
    languageRu:
        'Введи что-нибудь в строку поиска для получения списка пользователей!',
    languageUa:
        'Введи що-небудь в рядок пошуку для отримання списку користувачів!',
    languagePl:
  ...
  'NoComplaintsHere': {
    languageEn:
        "There are no complaints! Looks like everything has already been processed",
    languageRu: 'Жалоб нет! Похоже, что всё уже обработано',
    languageUa: 'Скарг немає! Здається, все вже оброблено',
    languagePl:
  ...
  'ConfigsDeletion': {
    ...
    languageRu: 'Удаление конфигураций',
  ...
  'ReviewsDeletion': {
    ...
    languageRu: 'Удаление комментариев',
  ...
  'DeleteJustThisReview': {
    ...
    languageRu: 'Удалить только этот комментарий',
  ...
  'DeleteJustThisConfig': {
    ...
    languageRu: 'Удалить только эту конфигурацию',
  ...
  'DeleteAllReviewsForWeek': {
    ...
    languageRu: 'Удалить все комментарии за неделю',
  ...
  'DeleteAllConfigsForWeek': {
    ...
    languageRu: 'Удалить все конфигурации за неделю',
  ...
  'DeleteAllReviews': {
    ...
    languageRu: 'Удалить все комментарии за всё время',
  ...
  'DeleteAllConfigs': {
    ...
    languageRu: "Удалить все конфигурации за всё время",
  ...
  'AppropriateExtension': {
    ...
    languageRu: 'Правильное расширение',
  ...
  'SpecialThanksForTranslation': {
    languageEn:
        "Special thanks to {users} for their help in translation of ExLoader for this language!",
    languageRu:
        'Отдельная благодарность {users} за помощь в переводе ExLoader на этот язык!',
    languageUa:
        'Окрема подяка {users} за допомогу в перекладі ExLoader на цю мову!',
    languagePl:
  ...
  'ChooseGameFirst': {
    ...
    languageRu: 'Для захода в библиотеку тебе необходимо выбрать игру!',
  ...
  'ThatPlaceWhere': {
    languageEn:
        "Need to find out which folder configs and other\nmodification files are installed in? Then click here!",
    languageRu:
        'Хочешь узнать в какую папку устанавливаются конфиги\nи остальные файлы модификации? Тогда тебе сюда!',
    languageUa:
        'Хочеш дізнатися в яку папку встановлюються конфіги\nі інші файли модифікації? Тоді тобі сюди!',
    languagePl:
  ...
  'FailedToApplySystemFeature': {
    ...
    languageRu: 'К сожалению, твоя система не поддерживает данную функцию',
  ...
  'WindowSize': {
    ...
    languageRu: 'Размер окна ExLoader',
  ...
  'SizeChangeConsequences': {
    languageEn:
        "Changing the size of the application window may cause some widgets to jump while scrolling or while hovering over them with the mouse cursor. Unfortunately, this problem is related directly with the engine of our application and will be fixed only when the framework developers fix it",
    languageRu:
        'Изменение размера окна приложения может привести к тому, что некоторые виджеты начнут прыгать при скроллинге или же при наведении на них курсором мышки. К сожалению, данная проблема напрямую связаны с движком нашего приложения и будет исправлена лишь тогда, когда её починят разработчики фреймворка',
    languageUa:
        "Зміна розміру вікна програми може привести до того, що деякі віджети почнуть стрибати при скролінгу або ж при наведенні на них курсором мишки. На жаль, дана проблема безпосередньо пов'язані з движком нашого застосування і буде виправлена лише тоді, коли її полагодять розробники фреймворка",
    languagePl:
  ...
  'VideoDeletion': {
    ...
    languageRu: 'Удалить видео-обзор',
  ...
  'OldPCsAndSounds': {
    languageEn:
        "Please, note that the sound effects features may work with a slight delay on old devices",
    languageRu:
        'Обрати внимание, на слабых компьютерах функции звуковых эффектов могут работать с небольшой задержкой',
    languageUa:
        "Зверни увагу, на слабких комп'ютерах функції звукових ефектів можуть працювати з невеликою затримкою",
    languagePl:
  ...
  'AutoUpdateAudioDescription': {
    languageEn:
        "Application will automatically check the sound pack for its updates every time its is launched!",
    languageRu:
        'Приложение самостоятельно будет проверять наличие обновлений звукового пака при каждом своём запуске!',
    languageUa:
        'Додаток самостійно буде перевіряти наявність оновлень звукового пака при кожному своему запуску!',
    languagePl:
  ...
  'AllModsForGamesInOnePlace': {
    languageEn:
        'We have collected all cool and free mods for popular games in one unified place',
    languageRu:
        'Мы собрали все самые крутые бесплатные моды к популярным играм в одном едином месте',
    languageUa:
        'Ми зібрали всі найкрутіші безкоштовні моди до популярних ігор в одному єдиному місці',
    languagePl:
        "Zebraliśmy wszystkie najfajniejsze darmowe mody do popularnych gier w jednym miejscu",
    languageDe:
        'Wir haben die coolsten kostenlosen Mods für beliebte Spiele an einem einzigen Ort gesammelt',
    languageIt:
        'Abbiamo raccolto tutte le mod gratuite per i giochi più popolari in un unico posto.',
    languageTr:
        "Popüler oyunlar için tüm harika ve ücretsiz modları tek bir yerde topladık",
    languageEs:
  ...
  'LogInEasily': {
    ...
    languagePl: "Zaloguj się łatwo, aby rozpocząć,",
    languageDe: "Melden Sie sich an, um loszulegen,",
  ...
  'OnlyEmail': {
    ...
    languagePl: "potrzebny jest tylko Twój",
    languageDe: "Sie brauchen nur Ihre",
  ...
  'IsNeeded': {
    ...
    languagePl: "adres e-mail",
    languageDe: "E-Mail-Adresse",
  ...
  'LogInEmail': {
    ...
    languagePl: "Zaloguj się za pomocą e-maila",
    languageDe: "Mit E-Mail anmelden",
  ...
  'UserAgreement': {
    languageEn:
        "By clicking «Yes, log-in as a guest» you agree to the End user license agreement!",
    languageRu:
  ...
  'SettingsDescription': {
    languageEn:
        "Manage the app's appearance, it's downloading settings, audio and notifications systems, and your profile preferences!",
    languageRu:
    ...
    languagePl:
        "Zarządzaj wyglądem aplikacji, ustawieniami pobierania, systemami audio i powiadomień oraz preferencjami profilu!",
    languageDe:
        "Verwalten Sie das Erscheinungsbild der App, die Einstellungen für das Herunterladen, die Audio- und Benachrichtigungssysteme und Ihre Profileinstellungen!",
    languageIt:
  ...
  'ExploreOurCollection': {
    languageEn:
        'In this list you will find both the library we have collected for you and all manually added images',
    languageRu:
    ...
    languagePl:
        "Na tej liście znajdziesz zarówno bibliotekę, którą zebraliśmy dla Ciebie, jak i wszystkie ręcznie dodane obrazy",
    languageDe:
        "In dieser Liste finden Sie sowohl die Bibliothek, die wir für Sie zusammengestellt haben, als auch alle manuell hinzugefügten Bilder",
    languageIt:
  ...
  'NoSocials': {
    languageEn:
        'This user has not added his social networks to the profile settings yet',
    languageRu:
        'Этот пользователь ещё не добавлял свои социальные сети в настройки профиля',
    languageUa:
        'Цей користувач ще не додав свої соціальні мережі до налаштувань профілю',
    languagePl:
  ...
  'AcrylicEffectDescription': {
    languageEn:
        "Applies the transparency and blur effects to the application's window. Disables some other visual effects and settings!",
    languageRu:
        'Применяет эффект совмещения прозрачности и размытия к окну приложения. Отключает некоторые другие визуальные эффекты и настройки!',
    languageUa:
        'Застосовує ефект поєднання прозорості та розмиття до вікна програми. Вимикає деякі інші візуальні ефекти та налаштування!',
    languagePl:
  ...
  'RecommendedImageSize': {
    languageEn:
        "Please note, we recommend to upload full-screen screenshots without any cropping to achieve the best quality!",
    languageRu:
        'Обрати внимание, для достижения наилучшего качества мы рекомендуем загружать полноэкранные скриншоты без каких-либо обрезок!',
    languageUa:
        'Зверни увагу, для досягнення найкращої якості ми рекомендуємо завантажувати повноекранні скріншоти без будь-яких обрізок!',
    languagePl:
  ...
  'PopularModsOfTheWeek': {
    ...
    languageRu: 'Популярные модификации недели',
  ...
  'PopularReviewsOfTheWeek': {
    ...
    languageRu: 'Популярные комментарии недели',
  ...
  'PopularConfigsOfTheWeek': {
    ...
    languageRu: 'Популярные конфиги и ЛУА недели',
  ...
  'ModificationIsDeleted': {
    ...
    languageRu: 'Модификация уже удалена',
  ...
  'EmailAuthIsDisabled': {
    languageEn:
        "It looks like Email authorisation is temporarily unavailable, try logging in with Google!",
    languageRu:
        'Похоже, что Email авторизация временно недоступна, попробуй войти с помощью Google!',
    languageUa:
        "Схоже, що Email авторизація тимчасово недоступна, спробуй увійти за допомогою Google!",
    languagePl:
  ...
  'OpenInYouTube': {
    ...
    languageRu: 'Открыть видео в YouTube',
  ...
  'SkipAllTips': {
    ...
    languageRu: 'Отметить все подсказки прочитанными',
  ...
  'HintsMarkedAsRead': {
    languageEn:
        "That's it, all the tips and training banners are marked as shown!",
    languageRu:
        'Готово, все подсказки и обучающие баннеры отмечены как прочитанные!',
    languageUa:
        'Готово, всі підказки та навчальні банери відзначені як прочитані!',
    languagePl:
  ...
  'InvalidYouTubeUrl': {
    languageEn:
        "Unfortunately, we won't be able to add this YouTube video, there seems to be something wrong with it. Make sure the link is entered correctly and your video is available for others!",
    languageRu:
        'К сожалению, мы не сможем добавить данное YouTube видео, похоже, что с ним что-то не так. Убедись, что ссылка введена верно и видео доступно для просмотра другим пользователям!',
    languageUa:
        "На жаль, ми не зможемо додати це YouTube відео, схоже, що з ним щось не так. Переконайся, що посилання введено правильно і відео доступне для перегляду іншим користувачам!",
    languagePl:
  ...
  'GifAvatarIsNotAllowed': {
    languageEn:
        "Unfortunately, your reputation level is too low to set up an animated avatar",
    languageRu:
        'К сожалению, твой уровень репутации слишком низок, дабы установить анимированную аватарку',
    languageUa:
        "На жаль, твій рівень репутації занадто низький, щоб встановити анімовану аватарку",
    languagePl:
  ...
  'VideoIsNotAllowed': {
    ...
    languageRu:
        'Для загрузки видео необходим более высокий уровень репутации, чем тот, что есть у тебя',
    languageUa:
        "Для завантаження відео необхідний вищий рівень репутації, ніж той, що є у тебе",
    languagePl:
  ...
  'YouTubeCFGReview': {
    ...
    languageRu: 'Видео-обзор конфига или же ЛУА на YouTube',
  ...
  'EditYourVideoBeforePublish': {
    languageEn:
        "To make sure this video is relevant to our app and is not spam, please add the word «{word}» to its description or its title!",
    languageRu:
        'Дабы убедиться, что это видео имеет отношение к нашему приложению и не является спамом, просим вас добавить слово «{word}» в описание или же название вашего видео!',
    languageUa:
        "Щоб переконатися, що це відео має відношення до нашого додатка і не є спамом, просимо вас додати слово «{word}» в опис або ж назву вашого відео!",
    languagePl:
  ...
  'ActiveUser': {
    ...
    languageRu: 'Активный пользователь',
  ...
  "AvailableFromLvl": {
    ...
    languageRu: 'Доступно начиная с {level} уровня репутации',
  ...
  'ReputationAndWhatIsIt': {
    ...
    languageRu: 'Уровни репутации и что это такое',
  ...
  'ReputationExLoader': {
    languageEn: '''
Levels from -4 and above:
 - You can't set dislikes or likes
 - You can write only 2 comments per day
 - You can upload only 1 config per day
 - You can't complain about other people's
 comments, configs or lua

Levels from -3 to -1:
 - You can set 1 dislike per day, you can't set likes
 - You can post only 4 comments per day
 - You can upload only 2 configs per day
 - You can leave only 1 complaint per day about
 someone else's configs, lua or comments

Level 0:
 - You can set only 2 dislikes per day
 - You can write only 6 comments per day
 - You can upload only 4 configs per day
 - You can leave only 2 complaints per day about
 someone else's configs, lua or comments
...
Reputation is given and taken away for participation in the social life of the app, such as for received likes and dislikes, writing comments, uploading configs, bans, etc. You can see your reputation level in your profile! By the way, during holidays and themed events, all the experience you get is doubled.''',
    languageRu: '''
Уровни от -4 и выше:
 - Нельзя ставить дизлайки или лайки
 - Можно писать только 2 комментария в день
 - Можно загружать только 1 конфиг в день
 - Нельзя жаловаться на чужие комментарии,
 конфиги или луа

Уровни от -3 до -1:
 - Можно ставить только 1 дизлайк в день, нельзя
 ставить лайки
 - Можно писать только 4 комментария в день
 - Можно загружать только 2 конфига в день
 - Можно оставлять только 1 жалобу в день на чужие
 конфиги, луа или же комментарии

Уровень 0:
 - Можно ставить только 2 дизлайка в день
 - Можно писать только 6 комментариев в день
 - Можно загружать только 4 конфига в день
 - Можно оставлять только 2 жалобы в день на чужие
 конфиги, луа или же комментарии
...
Репутация выдаётся и отнимается за участие в социальной жизни приложения, например, за полученные лайки или же дизлайки, за написание комментариев, загрузку конфигов, баны и т.д. Свой уровень репутации можно посмотерть у себя в профиле! Кстати, во время праздников и тематических ивентов весь получаемый опыт удваивается.''',
    languageUa: '''
Рівні від -4 і вище:
 - Не можна ставити дизлайки або лайки
 - Можна писати 2 коментарі на день
 - Можна завантажувати 1 конфіг на день
 - Не можна скаржитися на чужі коментарі,
 конфіги або луа

Рівні від -3 до -1:
 - Можна ставити 1 дизлайк на день, не можна ставити лайки
 - Можна писати 4 коментарі на день
 - Можна завантажувати 2 конфіги на день
 - Можна залишати 1 скаргу на день на чужі
 конфіги, луа або ж коментарі

Рівень 0:
 - Можна ставити 2 дизлайки на день
 - Можна писати 6 коментарів на день
 - Можна завантажувати 4 конфіги на день
 - Можна залишати 2 скарги на день на чужі
 конфіги, луа або ж коментарі
...
Репутацію видають і забирають за участь у соціальному житті застосунку, наприклад, за отримані лайки або ж дизлайки, за написання коментарів, завантаження конфігів, бани тощо. Свій рівень репутації можна подивитися у себе в профілі! До речі, під час свят і тематичних івентів весь одержуваний досвід подвоюється.''',
    languagePl: '''
Poziomy od -4 wzwyż:
 - Nie można nie lubić ani polubić
 - Możesz napisać 2 komentarze dziennie
 - Możesz przesłać 1 konfigurację dziennie
 - Nie możesz narzekać na komentarze innych osób,
 konfiguracje lub lua innych osób

Poziomy od -3 do -1:
 - Możesz opublikować 1 dislikes dziennie, nie możesz
 opublikować likes
 - Możesz opublikować 4 komentarze dziennie
 - Możesz przesłać 2 konfiguracje dziennie
 - Możesz zostawić 1 skargę dziennie na czyjeś
 konfiguracje, lua lub komentarze

Poziom 0:
 - Możesz umieścić 2 dislikes dziennie
 - Możesz napisać 6 komentarzy dziennie
 - Możesz przesłać 4 konfiguracje dziennie
 - Możesz zostawić 2 skargi dziennie dotyczące
 cudzych konfiguracje, lua lub komentarze
...
Levels von -4 und höher:
 - Sie können nicht dislikes oder likes
 - Du kannst 2 Kommentare pro Tag schreiben
 - Du kannst 1 Konfiguration pro Tag hochladen
 - Du kannst dich nicht über die Kommentare anderer
 Leute beschweren, Configs oder Lua

Levels von -3 bis -1:
 - Du kannst 1 Dislikes pro Tag posten, keine Likes
 - Du kannst 4 Kommentare pro Tag posten
 - Du darfst 2 Configs pro Tag hochladen
 - Du darfst 1 Beschwerde pro Tag über die
 Konfigs, Lua oder Kommentare

Stufe 0:
 - Du kannst 2 Dislikes pro Tag schreiben
 - Du kannst 6 Kommentare pro Tag schreiben
 - Du kannst 4 Configs pro Tag hochladen
 - Du kannst 2 Beschwerden pro Tag über andere
 Configs, Lua oder Kommentare
...
""",
  ...
  'ProtectedLuasAreNotAllowed': {
    languageEn:
        "Unfortunatelly you can not upload unsafe or protected or obfuscated LUAs. It's prohibited to ensure other users safety! The checking strictness of your LUA decreases as your reputation level increases.",
    languageRu:
        'К сожалению, загрузка небезопасных LUA или LUA с протектом(защитой) запрещена в целях обеспечения безопасности других пользователей! Строгость проверки твоих LUA понижается с увеличением уровня репутации.',
    languageUa:
        'На жаль, завантаження небезпечних LUA або LUA із протектом(захистом) заборонено з метою забезпечення безпеки інших користувачів! Суворість перевірки твоїх LUA знижується зі збільшенням рівня репутації.',
    languagePl:
  ...
  'ReputationLevelProgress': {
    languageEn:
        "You have already gained {experience} to your next reputation level!",
    languageRu:
        'Ты набрал уже {experience} опыта до следующего уровня репутации!',
    languageUa:
        "Ти набрав вже {experience} досвіду до наступного рівня репутації!",
  ...
  'NameRandomization': {
    ...
    languageRu: 'Рандомизация названия',
  ...
  'ReputationControll': {
    ...
    languageRu: 'Управление опытом репутации',
  ...
  'ViewTextGuide': {
    ...
    languageRu: 'Показать текстовую инструкцию',
    languageUa: 'Показати текстову інструкцію',
    languagePl: 'Pokaż instrukcje tekstowe',
    languageDe: "Textanweisungen anzeigen",
    languageIt: 'Mostra istruzioni di testo',
  ...
  'VideoGuideDescription': {
    languageEn:
        "Video guide that shows how to launch or how to use this modification:",
    languageRu:
        'Видео-инструкция по запуску или же использованию этой модификации:',
    languageUa:
        'Відео-інструкція із запуску або ж використання цієї модифікації:',
    languagePl:
        'Instrukcje wideo dotyczące uruchamiania lub korzystania z tej modyfikacji:',
    languageDe:
        "Video-Anleitung für den Start oder die Verwendung dieser Modifikation:",
    languageIt:
        'Istruzioni video su come avviare o utilizzare questa modifica:',
    languageTr:
        "Bu modifikasyonun nasıl başlatılacağı veya kullanılacağı hakkında video talimatı:",
    languageEs:
  ...
  'UpdateSourceLink': {
    languageEn: "Issue information/link for update",
    languageRu: 'Информация о поломке/ссылка на апдейт',
    languageUa: 'Інформація про поломку/посилання на апдейт',
    languagePl: 'Informacje o wydaniu / link do aktualizacji',
    languageDe: "Ausgabe von Informationen/Link zur Aktualisierung",
    languageIt: "Informazioni sul rilascio/link per l'aggiornamento",
    languageTr: "Güncelleme için bilgi/bağlantı yayınlayın",
    languageEs: "Emitir información/enlace para la actualización",
    languageCn: "发行信息/更新链接",
  },
  'LinkIsEmpty': {
  ...
  'IDoNotKnowTheUpdateLink': {
    languageEn:
        "This mod has just stopped working after the lastest game update and I want to report it!",
    languageRu:
  ...
  'NoComments': {
    languageEn:
        "It looks like that no one has added a single review for this mod, cfg or lua yet. You can be the first one to do it!",
    languageRu:
        'Похоже, что ещё никто не добавил свой отзыв к этому моду, кфг или же луа. Ты можешь стать первым!',
    languageUa:
        "Схоже, що ще ніхто не додав свій відгук до цього моду, кфг або луа. Ти можеш стати першим!",
    languagePl:
        'Wygląda na to, że nikt jeszcze nie dodał swojej recenzji dla tego modu, cfg lub lua. Możesz być pierwszy!',
    languageDe:
        "Sieht so aus, als hätte noch niemand seine Bewertung für diese mod, cfg oder lua abgegeben. Sie können der Erste sein!",
    languageIt:
        'Sembra che nessuno abbia ancora aggiunto una singola recensione per questa mod, cfg o lua. Puoi essere il primo a farlo!',
    languageTr:
        "Görünüşe göre henüz kimse bu mod, cfg veya lua için tek bir yorum eklememiş. Bunu yapan ilk kişi siz olabilirsiniz!",
    languageEs:
  ...
  'PopularInSeason': {
    ...
    languageIt: 'Popolare in stagione',
  ...
  'DownloadLinksCanBeFoundInTheLibrary': {
    languageEn:
        "Download links for this pirated version of the game are available in the ExLoader library, where all the mods for {game} are located!",
    languageRu:
        'Ссылки на скачивание этой самой пиратской версии игры доступны в библиотеке ExLoader, там, где расположены все моды для {game}!',
    languageUa:
        'Посилання на скачування цієї самої піратської версії гри доступні в бібліотеці ExLoader, там, де розташовані всі моди для {game}!',
    languagePl:
        'Linki do pobrania tej pirackiej wersji gry są dostępne w bibliotece ExLoader, gdzie znajdują się wszystkie mody do {game}!',
    languageDe:
        'Download-Links für diese sehr raubkopierte Version des Spiels sind in der ExLoader-Bibliothek verfügbar, wo sich alle Mods für {game} befinden!',
    languageIt:
        "I link per il download di questa versione pirata del gioco sono disponibili nella libreria ExLoader, dove si trovano tutte le mod per {game}!",
    languageTr:
        "Oyunun bu korsan sürümü için indirme bağlantıları, {game} için tüm modların bulunduğu ExLoader kütüphanesinde mevcuttur!",
    languageEs:
  ...
  'DownloadLinksCanBeFoundInTheInternet': {
    languageEn:
        "Download links for this pirated version of the game can be found in YouTube or with any search engine in the internet, that's not that hard!",
    languageRu:
        'Ссылки на скачивание этой самой пиратской версии игры ты можешь найти в YouTube или же в поисковике своего браузера, это не сложно!',
    languageUa:
        'Посилання на скачування цієї самої піратської версії гри ти можеш знайти в YouTube або ж у пошуковику свого браузера, це не складно!',
    languagePl:
        'Linki do pobrania tej bardzo pirackiej wersji gry można znaleźć na YouTube lub w wyszukiwarce przeglądarki, nie jest to trudne!',
    languageDe:
        'Sie können Links zum Herunterladen dieser sehr raubkopierten Version des Spiels auf YouTube oder in Ihrer Browser-Suchmaschine finden, es ist nicht schwer',
    languageIt:
        "I link per il download di questa versione pirata del gioco possono essere trovati su YouTube o con qualsiasi motore di ricerca in internet, non è così difficile!",
    languageTr:
        "Oyunun bu korsan sürümü için indirme bağlantıları YouTube'da veya internetteki herhangi bir arama motorunda bulunabilir, bu o kadar da zor değil!",
    languageEs:
  ...
  'LookForModsVersions': {
    languageEn:
        "When choosing a version of the pirate client, focus on those versions that are supported by this modification: {versions}.",
    languageRu:
        'При выборе версии пиратского клиента ориентируйся на те версии, которые поддерживаются модификацией: {versions}.',
    languageUa:
        'Під час вибору версії піратського клієнта орієнтуйся на ті версії, які підтримуються модифікацією: {versions}.',
    languagePl:
        'Wybierając wersję pirackiego klienta, należy skupić się na tych wersjach, które są obsługiwane przez modyfikację: {versions}.',
    languageDe:
        'Bei der Auswahl einer Version des Piratenclients sollten Sie sich auf die Versionen konzentrieren, die von der Modifikation unterstützt werden: {versions}.',
    languageIt:
        "Quando si sceglie una versione del client pirata, concentrarsi sulle versioni supportate da questa modifica: {versions}.",
    languageTr:
        "Korsan istemcinin bir sürümünü seçerken, bu değişiklik tarafından desteklenen sürümlere odaklanın: {versions}.",
    languageEs:
  ...
  'ThereMightBeAnAntivirusIssue': {
    languageEn:
        "It seems that during the last launch of one of the modifications you encountered an ExLoader crash. Most likely, this happened due to some antivirus software that prevents modifications from being launched. In this situation, the only solution to the problem is to completely remove those antiviruses that could affect it. Note, the removal of antivirus should be done from the Windows Control Panel, not with the help of some third-party utilities.\n\nIf you have already uninstalled all interfering antiviruses, but the problem persists, try to download the «Antivirus name uninstall tool» until on the official website of the antivirus, and uninstall this software with it!\n\nYou can just skip this error using the button below!",
    languageRu:
        'Похоже, что во время прошлого запуска одной из модификации ты столкнулся с вылетом ExLoader. Вероятнее всего, это связано с каким-то антивирусом, который мешает запуску модификаций. В данной ситуации единственным решением проблемы таких вылетов является полное удаление тех антивирусов, которые могли на это повлиять. Обрати внимание, удаление антивируса необходимо выполнять из панели управления Windows, а не с помощью каких-то сторонних утилит.\n\nЕсли ты уже удалил все мешающие антивирусы, но проблема сохранилась, попробуй скачать утилиту «Название антивируса uninstall tool» на официальном сайте антивируса, и удалить данное ПО с помощью неё!\n\nЕсли что, эту ошибку можно просто пропустить с помощью кнопки ниже!',
    languageUa:
        "Схоже, що під час минулого запуску однієї з модифікацій ти зіткнувся з вильотом ExLoader. Найімовірніше, це пов'язано з якимось антивірусом, який заважає запуску модифікацій. У цій ситуації єдиним вирішенням проблеми таких вильотів є повне видалення тих антивірусів, які могли на це вплинути. Зверни увагу, видалення антивірусу необхідно виконувати з панелі керування Windows, а не за допомогою якихось сторонніх утиліт.\n\nЯкщо ти вже видалив усі антивіруси, що заважають, але проблема збереглася, спробуй завантажити утиліту «Назва антивірусу uninstall tool» на офіційному сайті антивірусу та видалити це ПЗ за допомогою неї!\n\nЦю помилку можна просто пропустити за допомогою кнопки нижче!",
    languagePl:
        'Wygląda na to, że podczas ostatniego uruchomienia jednej z modyfikacji wystąpiła awaria programu ExLoader. Najprawdopodobniej jest to spowodowane przez jakiś program antywirusowy, który uniemożliwia uruchomienie modyfikacji. W tej sytuacji, jedynym rozwiązaniem problemu takich dropoutów jest całkowite usunięcie tych antywirusów, które mogą mieć na to wpływ. Uwaga, usuwanie programów antywirusowych powinno odbywać się z poziomu Panelu sterowania systemu Windows, a nie za pomocą narzędzi innych firm.\n\nJeśli odinstalowałeś już wszystkie przeszkadzające programy antywirusowe, ale problem nadal występuje, spróbuj pobrać narzędzie «Antivirus nazwa uninstall tool» na oficjalnej stronie programu antywirusowego i odinstaluj to oprogramowanie za jego pomocą!\n\nW razie czego, możesz po prostu pominąć ten błąd za pomocą przycisku poniżej!',
    languageDe:
        'Es scheint, dass Sie bei der letzten Ausführung einer der Modifikationen einen ExLoader-Absturz erlitten haben. Höchstwahrscheinlich ist dies auf ein Antivirenprogramm zurückzuführen, das die Ausführung von Modifikationen verhindert. In dieser Situation besteht die einzige Lösung für das Problem solcher Aussetzer darin, die Antivirenprogramme, die es beeinflussen könnten, vollständig zu entfernen. Beachten Sie, dass die Entfernung von Antivirenprogrammen über die Systemsteuerung von Windows erfolgen sollte, nicht mit Hilfe von Dienstprogrammen Dritter.\n\nWenn Sie bereits alle störenden Antivirenprogramme deinstalliert haben, das Problem aber weiterhin besteht, versuchen Sie, das Hilfsprogramm «Antivirus name uninstall tool» auf der offiziellen Website des Antivirenprogramms herunterzuladen, und deinstallieren Sie diese Software damit!\n\nWenn nicht, können Sie diesen Fehler mit der unten stehenden Schaltfläche einfach übergehen!',
    languageIt:
        "Sembra che durante l'ultimo lancio di una delle modifiche si sia verificato un arresto anomalo di ExLoader. Molto probabilmente ciò è avvenuto a causa di un software antivirus che impedisce l'avvio delle modifiche. In questa situazione, l'unica soluzione al problema è rimuovere completamente gli antivirus che potrebbero influire. Si noti che la rimozione degli antivirus deve essere eseguita dal Pannello di controllo di Windows, non con l'aiuto di alcune utility di terze parti.\n\nSe avete già disinstallato tutti gli antivirus che interferiscono, ma il problema persiste, provate a scaricare lo «Strumento di disinstallazione del nome dell'antivirus» fino al sito ufficiale dell'antivirus, e disinstallate questo software con esso!\n\nPotete evitare questo errore utilizzando il pulsante qui sotto!",
    languageTr:
        "Görünüşe göre değişikliklerden birinin son başlatılması sırasında bir ExLoader çökmesiyle karşılaştınız. Büyük olasılıkla bu, değişikliklerin başlatılmasını engelleyen bazı antivirüs yazılımları nedeniyle meydana geldi. Bu durumda, sorunun tek çözümü, onu etkileyebilecek antivirüsleri tamamen kaldırmaktır. Antivirüsün kaldırılmasının bazı üçüncü taraf yardımcı programların yardımıyla değil, Windows Denetim Masası'ndan yapılması gerektiğini unutmayın.\n\nMüdahale eden tüm antivirüsleri zaten kaldırdıysanız, ancak sorun devam ediyorsa, antivirüsün resmi web sitesine kadar «Antivirüs adı kaldırma aracını» indirmeyi deneyin ve bu yazılımı onunla kaldırın!\n\nAşağıdaki düğmeyi kullanarak bu hatayı atlayabilirsiniz!",
    languageEs:
  ...
  'NextCheckWithin': {
    ...
    languageRu: 'Следующая проверка игры через',
    languageUa: 'Наступна перевірка гри через',
    languagePl: 'Następny test gry przez',
    languageDe: 'Der nächste Spieltest durch',
    languageIt: "Il prossimo playtest attraverso",
  ...
  'MirrorBackground': {
    ...
    languageRu: 'Отзеркаливать картинку заднего фона',
    languageUa: 'Віддзеркалювати картинку заднього фону',
    languagePl: 'Aby wykonać odbicie lustrzane obrazu tła',
    languageDe: "So spiegeln Sie das Hintergrundbild",
    languageIt: "Specchia l'immagine di sfondo selezionata",
  ...
  'MirrorBackgroundDescription': {
    languageEn:
        'Selected image will be reversed from left to right or vice versa, depending on whether this option is enabled or not',
    languageRu:
        'Выбранная картинка будет перевёрнута слева на право или же наоборот, в зависимости от включенности данной опции',
    languageUa:
        'Обрана картинка буде перевернута зліва на право або ж навпаки, залежно від увімкнення цієї опції',
    languagePl:
        'Wybrane zdjęcie zostanie odwrócone od lewej do prawej lub odwrotnie, w zależności od tego, czy opcja ta jest włączona',
    languageDe:
        "Das ausgewählte Bild wird von links nach rechts oder umgekehrt gedreht, je nachdem, ob diese Option aktiviert ist oder nicht",
    languageIt:
        "L'immagine selezionata verrà invertita da sinistra a destra o viceversa, a seconda che l'opzione sia abilitata o meno.",
    languageTr:
        "Seçilen görüntü, bu seçeneğin etkin olup olmamasına bağlı olarak soldan sağa veya tam tersi şekilde ters çevrilecektir",
    languageEs:
  ...
  'PlaytimeSort': {
    ...
    languageRu: 'По наигранному времени',
    languageUa: 'За награним часом',
    languagePl: "Jeśli chodzi o czas gry",
    languageDe: "Nach Spielzeit",
    languageIt: "Per il tempo totale di gioco",
  ...
  'LastLaunchSort': {
    ...
    languageRu: 'По дате последнего запуска',
    languageUa: 'За датою останнього запуску',
    languagePl: "Według daty ostatniego uruchomienia",
  ...
  'LaunchesSort': {
    ...
    languageRu: 'По количеству запусков',
    languageUa: 'За кількістю запусків',
    languagePl: "Według liczby uruchomień",
  ...
  'MaybeVideoIsDeleted': {
    ...
    languageRu: 'Возможно это видео уже удалено!',
    languageUa: 'Можливо це відео вже видалено!',
    languagePl: "To wideo mogło już zostać usunięte!",
    languageDe: "Dieses Video kann bereits gelöscht worden sein!",
    languageIt: "Questo video potrebbe essere già stato cancellato!",
  ...
  'PleaseTellUsWhatIsWrong': {
    languageEn:
        'Describe the exact issue that happened with this mod in "{textishere}" column!',
    languageRu:
        'Опиши, что конкретно перестало работать или же сломалось в графе "{textishere}"!',
    languageUa:
        'Напиши, що конкретно перестало працювати або ж зламалося в графі "{textishere}"!',
    languagePl:
        'Napisz, co dokładnie przestało działać lub się zepsuło w kolumnie "{textishere}"!',
    languageDe:
        'Schreiben Sie in die Spalte "{textishere}", was genau nicht mehr funktioniert oder kaputt ist!',
    languageIt:
        'Descrivi il problema esatto che si è verificato con questa mod nella colonna "{textishere}"!',
    languageTr:
        'Bu modda meydana gelen sorunu "{textishere}" sütununda tam olarak açıklayın!',
    languageEs:
  ...
  'RecentReviewsDescription': {
    ...
    languageRu: 'Список последних комментариев ко всем модификациям',
    languageUa: 'Список останніх коментарів до всіх модифікацій',
    languagePl: "Lista ostatnich komentarzy do wszystkich modyfikacji",
    languageDe: "Liste der jüngsten Kommentare zu allen Änderungen",
    languageIt: "Elenco di tutte le recensioni recenti per tutte le modifiche",
    languageTr: "Tüm değişiklikler için son incelemelerin listesi",
    languageEs:
  ...
  'CFGFolderForDeletion': {
    ...
    languageIt:
        "Cartella di configurazione per la funzione di cancellazione di tutti i file",
    languageTr: "Tüm dosyaları silme işlevi için yapılandırma klasörü",
    languageEs:
        "Carpeta de configuración para la función de eliminación de todos los archivos",
    languageCn: "用于删除所有文件功能的配置文件夹",
  },
  "Hide": {
    languageEn: "Hide",
    languageRu: 'Скрыть',
    languageUa: "Приховати",
    languagePl: "Ukryj",
    languageDe: "Ausblenden",
    languageIt: "Nascondere",
    languageTr: "Gizle",
    languageEs: "Ocultar",
    languageCn: "隐藏",
  },
  ...
  'ExplainWhatToDoWithMobile': {
    languageEn: "After downloading mod's APK file, just transfer it to your Android phone and install it like a normal app. Don't forget to enable installation from untrusted sources in system settings! Or download ExLoader on your phone and our application will install this mod itself in automatic mode.",
    languageRu: "После скачивания APK файла просто перекинь его на свой Android телефон и установи как обычное приложение. Не забудь включить установку из непроверенных источников в настройках системы! Либо скачай ExLoader на свой телефон и приложение само установит мод в автоматическом режиме.",
    languageUa: "Після скачування APK файлу просто перекинь його на свій Android телефон і встанови як звичайний додаток. Не забудь увімкнути встановлення з неперевірених джерел у налаштуваннях системи! Або завантаж ExLoader на свій телефон і додаток сам встановить мод в автоматичному режимі.",
    languagePl: "Po pobraniu pliku APK moda, po prostu przenieś go na swój telefon z Androidem i zainstaluj jak zwykłą aplikację. Nie zapomnij włączyć instalacji z niezaufanych źródeł w ustawieniach systemu! Lub pobierz ExLoader na swój telefon, a nasza aplikacja sama zainstaluje ten mod w trybie automatycznym.",
    languageDe: "Nach dem Herunterladen der APK-Datei des Mods, übertragen Sie sie einfach auf Ihr Android-Telefon und installieren Sie sie wie eine normale App. Vergessen Sie nicht, die Installation aus nicht vertrauenswürdigen Quellen in den Systemeinstellungen zu aktivieren! Oder laden Sie ExLoader auf Ihr Handy und unsere Anwendung wird diese Mod selbst im automatischen Modus installieren.",
    languageIt: "Dopo aver scaricato il file APK della mod, trasferitelo sul vostro telefono Android e installatelo come una normale applicazione. Non dimenticate di abilitare l'installazione da fonti non attendibili nelle impostazioni di sistema! Oppure scaricate ExLoader sul vostro telefono e la nostra applicazione installerà questa mod da sola in modalità automatica.",
    languageTr: "Modun APK dosyasını indirdikten sonra, Android telefonunuza aktarın ve normal bir uygulama gibi yükleyin. Sistem ayarlarında güvenilmeyen kaynaklardan yüklemeyi etkinleştirmeyi unutmayın! Veya telefonunuza ExLoader'ı indirin ve uygulamamız bu modu otomatik modda kendisi yükleyecektir.",
    languageEs: "Después de descargar el archivo APK del mod, transfiérelo a tu teléfono Android e instálalo como una aplicación normal. No olvides activar la instalación desde fuentes no fiables en los ajustes del sistema. O descarga ExLoader en tu teléfono y nuestra aplicación instalará este mod por sí misma en modo automático.",
    languageCn: "下载 mod 的 APK 文件后，只需将其传输到 Android 手机，然后像安装普通应用程序一样安装即可。别忘了在系统设置中启用从不可信任来源安装！或者在您的手机上下载 ExLoader，我们的应用程序将以自动模式自行安装此 MOD。",
  },
  'UpdateFailedTrySettings': {
    languageEn: "An unexpected error has occurred while updating the application/installing a modification. Maybe ExLoader needs additional permissions to install applications from untrusted sources and access to the file system! Try granting all the necessary permissions in the settings and check again.",
    languageRu: "Произошла ошибка при обновлении приложения/установке модификации. Возможно ExLoader нуждается в дополнительных правах на установку приложений из неизвестных источников и к доступу к файловой системе! Попробуй выдать необходимые разрешения в настройках и проверить ещё раз.",
    languageUa: "Сталася помилка під час оновлення програми/встановлення модифікації. Можливо ExLoader потребує додаткових прав на встановлення застосунків із невідомих джерел і доступу до файлової системи! Спробуй видати необхідні дозволи в налаштуваннях і перевірити ще раз.",
    languagePl: "Wystąpił nieoczekiwany błąd podczas aktualizacji aplikacji/instalacji modyfikacji. Być może ExLoader potrzebuje dodatkowych uprawnień do instalowania aplikacji z niezaufanych źródeł i dostępu do systemu plików! Spróbuj nadać wszystkie niezbędne uprawnienia w ustawieniach i sprawdź ponownie.",
    languageDe: "Ein unerwarteter Fehler ist beim Aktualisieren der Anwendung/Installieren einer Änderung aufgetreten. Möglicherweise benötigt ExLoader zusätzliche Berechtigungen für die Installation von Anwendungen aus nicht vertrauenswürdigen Quellen und den Zugriff auf das Dateisystem! Versuchen Sie, alle erforderlichen Berechtigungen in den Einstellungen zu gewähren und prüfen Sie erneut.",
    languageIt: "Si è verificato un errore imprevisto durante l'aggiornamento dell'applicazione/installazione di una modifica. Forse ExLoader ha bisogno di ulteriori permessi per installare applicazioni da fonti non attendibili e per accedere al file system! Provate a concedere tutte le autorizzazioni necessarie nelle impostazioni e ricontrollate.",
    languageTr: "Uygulama güncellenirken/değişiklik yüklenirken beklenmedik bir hata oluştu. Belki de ExLoader'ın güvenilmeyen kaynaklardan uygulama yüklemek ve dosya sistemine erişmek için ek izinlere ihtiyacı vardır! Ayarlarda gerekli tüm izinleri vermeyi deneyin ve tekrar kontrol edin.",
    languageEs: "Se ha producido un error inesperado al actualizar la aplicación/instalar una modificación. Puede que ExLoader necesite permisos adicionales para instalar aplicaciones de fuentes no fiables y acceso al sistema de archivos. Intente conceder todos los permisos necesarios en la configuración y vuelva a comprobarlo.",
    languageCn: "在更新应用程序/安装修改时发生了意外错误。也许 ExLoader 需要额外的权限，才能从不靠谱的来源安装应用程序并访问文件系统！请尝试在设置中授予所有必要权限，然后再次检查。",
  },
  'NotifyUsItsEssential': {
    languageEn: "Be sure to let us know if this mod has stopped working after a game update. We physically do not have time to keep track of hundreds of mods and their updates, so we need your help here.",
    languageRu: "Обязательно сообщай нам о том, что какой-либо мод перестал работать после обновления игры. Мы физически не успеваем следить за работоспособностью сотен модов и их апдейтами, поэтому нам крайне важна твоя помощь.",
    languageUa: "Обов'язково повідомляй нам про те, що який-небудь мод перестав працювати після оновлення гри. Ми фізично не встигаємо стежити за працездатністю сотень модів і їхніми апдейтами, тому нам вкрай важлива твоя допомога.",
    languagePl: "Daj nam znać, jeśli ten mod przestał działać po aktualizacji gry. Fizycznie nie mamy czasu na śledzenie setek modów i ich aktualizacji, więc potrzebujemy twojej pomocy.",
    languageDe: "Bitte teilen Sie uns mit, wenn diese Mod nach einem Spiel-Update nicht mehr funktioniert. Wir haben nicht die Zeit, den Überblick über Hunderte von Mods und deren Updates zu behalten, daher brauchen wir hier eure Hilfe.",
    languageIt: "Assicuratevi di farci sapere se questa mod ha smesso di funzionare dopo un aggiornamento del gioco. Non abbiamo il tempo di tenere traccia di centinaia di mod e dei loro aggiornamenti, quindi abbiamo bisogno del vostro aiuto.",
    languageTr: "Bu mod bir oyun güncellemesinden sonra çalışmayı durdurduysa bize bildirdiğinizden emin olun. Yüzlerce modu ve güncellemelerini takip etmek için fiziksel olarak zamanımız yok, bu yüzden burada yardımınıza ihtiyacımız var.",
    languageEs: "Asegúrate de hacernos saber si este mod ha dejado de funcionar después de una actualización del juego. Físicamente no tenemos tiempo para hacer un seguimiento de cientos de mods y sus actualizaciones, por lo que necesitamos tu ayuda aquí.",
    languageCn: "如果该修改程序在游戏更新后停止工作，请务必通知我们。我们没有时间跟踪数百个修改器及其更新，因此我们需要您的帮助。",
  },
  'FailedToLaunceBecauseOfAC': {
    languageEn: "Unfortunately, ExLoader was unable to launch this modification because the game is protected by some anti-cheat (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC or some other anti-reader). Perhaps you should re-read the launch instructions for this modification (One of the buttons placed on the right side of modification's launch button) or try launching the game without an anti-cheat!",
    languageRu: "К сожалению, ExLoader не смог запустить эту модификацию из-за защиты игры античитом (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC или какого-то другого античита). Возможно, тебе следует перечитать инструкцию к запуску модификации (Одна из кнопок справа от кнопки запуска модификации) или же попытаться запустить игру без античита!",
    languageUa: "На жаль, ExLoader не зміг запустити цю модифікацію через захист гри античитом (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC або якогось іншого античита). Можливо, тобі слід перечитати інструкцію до запуску модифікації (Одна з кнопок праворуч від кнопки запуску модифікації) або ж спробувати запустити гру без античита!",
    languagePl: "Niestety, ExLoader nie był w stanie uruchomić tej modyfikacji, ponieważ gra jest chroniona przez jakiś anty-cheat (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC lub inny anty-reader). Być może powinieneś ponownie przeczytać instrukcje uruchamiania tej modyfikacji (jeden z przycisków umieszczonych po prawej stronie przycisku uruchamiania modyfikacji) lub spróbować uruchomić grę bez anty-cheata!",
    languageDe: "Leider war ExLoader nicht in der Lage, diese Modifikation zu starten, weil das Spiel durch einen Anti-Cheat (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC oder einen anderen Anti-Reader) geschützt ist. Vielleicht sollten Sie die Startanweisungen für diese Modifikation noch einmal lesen (eine der Schaltflächen auf der rechten Seite der Startschaltfläche der Modifikation) oder versuchen, das Spiel ohne Anti-Cheat zu starten!",
    languageIt: "Purtroppo ExLoader non è riuscito a lanciare questa modifica perché il gioco è protetto da qualche anti-cheat (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC o qualche altro anti-reader). Forse dovreste rileggere le istruzioni di lancio di questa modifica (uno dei pulsanti posti a destra del pulsante di lancio della modifica) o provare a lanciare il gioco senza un anti-cheat!",
    languageTr: "Ne yazık ki, ExLoader bu modifikasyonu başlatamadı çünkü oyun bazı anti-hile (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC veya başka bir anti-okuyucu) tarafından korunuyor. Belki de bu modifikasyonun başlatma talimatlarını tekrar okumalısınız (Modifikasyonun başlatma düğmesinin sağ tarafında bulunan düğmelerden biri) veya oyunu bir anti-hile olmadan başlatmayı denemelisiniz!",
    languageEs: "Desafortunadamente, ExLoader no pudo lanzar esta modificación porque el juego está protegido por algún anti-tramposo (EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC o algún otro anti-tramposo). Quizás deberías volver a leer las instrucciones de lanzamiento de esta modificación (uno de los botones situados a la derecha del botón de lanzamiento de la modificación) o intentar lanzar el juego sin un anti-tramposo.",
    languageCn: "不幸的是，ExLoader 无法启动此修改，因为游戏受到某些反作弊程序（EAC/BattleEye/FaceIt/ESEA/Vanguard/Byfron/MRAC 或其他反读取程序）的保护。也许您应该重新阅读该修改程序的启动说明（修改程序启动按钮右侧的按钮之一），或者尝试在没有反作弊程序的情况下启动游戏！",
  },
};
