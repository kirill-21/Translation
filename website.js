...
const translationElements = [
  ...
  },
  {
    name: 'CanIGetBannedDescription', value: {
      languageEn: "If the game for which you want to download cheats uses VAC anti-cheat system, then bans statistics for using each specific modifications for this game is available on the modification's card. If the game uses other anti-cheats (like ESEA, EAC, FaceIT, BattleEye, Vanguard, MRAC, etc.) our app will automatically inform you about all possible risks before launching a free cheat!",
  ...
  },
  {
    name: 'AreThereViruses', value: {
      languageEn: "Are there any viruses in cheats from your loader?",
  ...
  },
  {
    name: 'WhichCheatsExist', value: {
      languageEn: "Which types of cheats exist for",
  ...
  },
  {
    name: 'WhichCheatsExistDescription', value: {
      languageEn: "Generally, there are three types of cheats for each game: \"External\", \"Internal\" and neural networks. No injector is required to launch an External cheat, they are opened as a separate process and read game's memory to draw the so-called WH (ESP). Sometimes such mods can simulate keyboard buttons or mouse buttons pressing to handle such functions as aimbot, trigger, bunnyhop, grenades helper or movement recorder. In rare cases, external cheats can change process' memory, for example, to replace skins (the so-called skinchanger). Internal modifications are special DLL libraries that are injected into the game. Such cheats are characterized by smoother operation, the presence of extensive features, as well as the increased risk of getting banned if mod's developer did not protect his cheat from the basic anti-cheat system. Neural networks are something else, they do not interact with the memory of the game, but only analyze the image from the monitor, in order to recognize opponents for aim or automatic shooting purposes, as well as, in rare cases, for an automatic movement on the map. Such applications require a non-weak PC, however, are incredibly safe to use. In the ExLoader library you can find a huge amount of both Internal and External modifications with all features like WH, Aimbot, SkinChanger, movement recorder, grenades helper, etc.",
  ...
  },
  {
    name: 'IWantToDownloadCheats', value: {
      languageEn: "I want to download cheats, what do you have in your library?",
  ...
  },
  {
    name: 'IWantToDownloadCheatsDescriptionFirst', value: {
      languageEn: "It all depends on the game and the cheat developers! From time to time, such cheats appear in our library as",
  ...
  },
  {
    name: 'IWantToDownloadCheatsDescriptionSecond', value: {
      languageEn: ", etc. If the cheat supports the latest version of the game, you can download it for free and there are no viruses in it - it will appear in our library!",
  ...
  },
  {
    name: 'WhatToDoIfModIsNotLaunched', value: {
      languageEn: 'What do i do if cheat does not launch of crashes?',
  ...
  },
  {
    name: 'WhichButtonIsUsedForCheatMenuOpening', value: {
      languageEn: 'Which button opens cheat\'s menu?',
  ...
  },
  {
    name: 'WhereToDownloadInjector', value: {
      languageEn: 'Where can i get an injector to launch this cheat?',
  ...
  },
  {
    name: 'WhereToDownloadInjectorDescription', value: {
      languageEn: 'Many people use Ghost Injector, Extreme Injector, GHInjector, Vac-Bypass Injector, Kirin, etc. to launch common cheats with the .DLL extension, but in our case there is no need to download any additional software, ExLoader installs all modifications by itself, without any third-party software!',
