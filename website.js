...
const translationElements = [
  ...
  },
  {
    name: 'UnifiedLibraryDescription', value: {
      ...
      languagePl: 'Nasza aplikacja pomoże Ci pobrać cheaty lub hacki do CS2 i innych gier, w tym inh, trigger, ahim, wh, skinchanger, aim, skinchanger i wszystko to za darmo, bez żadnych wirusów.',
  ...
  },
  {
    name: 'HowToInstallExLoaderDescription', value: {
      ...
      languagePl: 'Zacznij od pobrania naszego oficjalnego instalatora za pomocą dużego przycisku na górze tej strony. Otwórz pobrany plik, wybierz ścieżkę, gdzie ExLoader zostanie zainstalowany i kliknij na kontynuuj. Rozpocznie się proces instalacji, który zazwyczaj trwa od 10 do 20 sekund w zależności od prędkości internetu. Po zakończeniu procesu, zostaniesz zaprezentowany w ExLoader, gdzie będziesz musiał zalogować się za pomocą swojego e-maila lub konta Google, żadne hasła nie są wymagane! Gdy już to zrobisz, możesz wybrać grę, w której chcesz uruchomić mod i dostać się do biblioteki cheatów lub hacków dla tej gry. To tylko kwestia wybrania swoich ulubionych cheatów lub hacków i naciśnięcia przycisku Run!',
