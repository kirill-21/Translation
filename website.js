...
const translationElements = [
  ...
  },
  {
    name: 'WantedToDownloadSecond', value: {
      ...
      languageEs: 'sin virus? ¡Estás en ExLoader! Todas las trampas están actualizados para la última versión del juego e incluyen wh, aim, skins, etc.',
  ...
  },
  {
    name: 'MainPageTitle', value: {
      ...
      languageEs: 'ExLoader | Trampas para CS2 y otros juegos',
  ...
  },
  {
    name: 'MainPageDescription', value: {
      ...
      languageEs: 'Esta aplicación te ayudará a descargar trampas para CS2 y otros juegos, unos ejemplos seria como wallhack, trigger, skinchanger, aim y etc...',
  ...
  },
  {
    name: 'KeywordsTranslation', value: {
      ...
      languageEs: 'ExLoader, modificaciones, cs2, cs2 hacks, cs2 cheats, descargar, gratis, xloader, exlaoder, wh, aim, skin changer, bunnyhop, no ban, no virus',
  ...
  },
  {
    name: 'UnifiedLibraryDescription', value: {
      ...
      languageEs: 'Nuestra aplicación te ayudará a descargar trampas para CS2 y otros juegos, incluyendo wh, trigger, aim, skinchanger y todo esto es gratis, sin virus y seguro.',
  ...
  },
  {
    name: 'UnifiedLibraryDescriptionEnd', value: {
      ...
      languageEs: '¿Estabas buscando trampas para CS2 o algún otro juego? ¡Considérate afortunado!',
  ...
  },
  {
    name: 'Neuronet', value: {
      ...
      languageEs: 'Trampa-Neuronet | Bot',
  ...
  },
  {
    name: 'FarmBot', value: {
      ...
      languageEs: 'Trampa farm-bot | Bot',
  ...
  },
  {
    name: 'CanIGetBannedDescription', value: {
      ...
      languageEs: 'Si el juego para el que quieres descargar trampas tiene un sistema VAC, las estadísticas sobre el ban de uso de cada modificación específica para este juego están disponibles en la ficha de la propia modificación. Si el juego utiliza otros antilectores (como ESEA, EAC, FaceIT, BattleEye, Vanguard, MRAC, etc.), ¡nuestra aplicación te avisará automáticamente de todos los posibles riesgos antes de ejecutar el cheat gratuito!',
  ...
  },
  {
    name: 'AreThereViruses', value: {
      ...
      languageEs: '¿Hay algún virus en las trampas de su menu?',
  ...
  },
  {
    name: 'WhichCheatsExist', value: {
      ...
      languageEs: '¿Para qué sirven las distintas trampas?',
  ...
  },
  {
    name: 'IWantToDownloadCheats', value: {
      ...
      languageEs: 'Quiero descargar trampas, ¿qué hay disponible en su biblioteca?',
  ...
  },
  {
    name: 'IWantToDownloadCheatsDescriptionSecond', value: {
      ...
      languageEs: ', etc. Si la trampa es compatible con la última actualización del juego, se puede descargar de forma gratuita y está libre de virus - ¡aparecerá en nuestra biblioteca!',
  ...
  },
  {
    name: 'WhatToDoIfModIsNotLaunched', value: {
      ...
      languageEs: '¿Qué hacer si la trampa no se activa o no funciona?',
  ...
  },
  {
    name: 'WhichButtonIsUsedForCheatMenuOpening', value: {
      ...
      languageEs: '¿Qué botón abre el menú de las trampas?',
  ...
  },
  {
    name: 'WhereToDownloadInjector', value: {
      ...
      languageEs: '¿Dónde conseguir un inyector para ejecutar la trampa?',
